...
fn main() {
    ...
    let on_fulfilled = Function::new(&["value"], "console.log('Promise fulfilled with:', value); return 'ok';");
    let on_rejected = Function::new(&["reason"], "console.log('Promise rejected with:', reason); return 'fail';");
