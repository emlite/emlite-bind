...
impl std::ops::Deref for StorageAccessHandle {
    type Target = emlite::Val;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for StorageAccessHandle {
...
impl StorageAccessHandle {
    pub fn create_object_url(&self, obj: jsbind::Any) -> jsbind::DOMString {
        self.inner
...
impl StorageAccessHandle {
    pub fn revoke_object_url(&self, url: jsbind::DOMString) -> jsbind::Undefined {
        self.inner
...
impl StorageAccessHandle {
    pub fn broadcast_channel(&self, name: jsbind::DOMString) -> BroadcastChannel {
        self.inner
...
impl StorageAccessHandle {
    pub fn shared_worker0(&self, script_url: jsbind::USVString) -> SharedWorker {
        self.inner
            .call("SharedWorker", &[script_url.into()])
            .as_::<SharedWorker>()
    }

    pub fn shared_worker1(
        &self,
        script_url: jsbind::USVString,
        options: jsbind::Any,
    ) -> SharedWorker {
        self.inner
