...
impl MessageEvent {
    ...
    pub fn new0(type_: &JsString) -> MessageEvent {
        Self {
            inner: Any::global("MessageEvent").new(&[type_.into()]).as_::<Event>(),
        }
    }
    ...
    pub fn new1(type_: &JsString, event_init_dict: &MessageEventInit) -> MessageEvent {
        Self {
            inner: Any::global("MessageEvent").new(&[type_.into(), event_init_dict.into()]).as_::<Event>(),
        }
    }
...
impl MessageEvent {
    ...
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event2(&self, type_: &JsString, bubbles: bool, cancelable: bool) -> Undefined {
        self.inner.call("initMessageEvent", &[type_.into(), bubbles.into(), cancelable.into(), ]).as_::<Undefined>()
    }
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event3(&self, type_: &JsString, bubbles: bool, cancelable: bool, data: &Any) -> Undefined {
        self.inner.call("initMessageEvent", &[type_.into(), bubbles.into(), cancelable.into(), data.into(), ]).as_::<Undefined>()
    }
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event4(&self, type_: &JsString, bubbles: bool, cancelable: bool, data: &Any, origin: &JsString) -> Undefined {
        self.inner.call("initMessageEvent", &[type_.into(), bubbles.into(), cancelable.into(), data.into(), origin.into(), ]).as_::<Undefined>()
    }
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event5(&self, type_: &JsString, bubbles: bool, cancelable: bool, data: &Any, origin: &JsString, last_event_id: &JsString) -> Undefined {
    ...
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event6(&self, type_: &JsString, bubbles: bool, cancelable: bool, data: &Any, origin: &JsString, last_event_id: &JsString, source: &Any) -> Undefined {
    ...
    /// The initMessageEvent method.
    /// [`MessageEvent.initMessageEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent/initMessageEvent)
    pub fn init_message_event7(&self, type_: &JsString, bubbles: bool, cancelable: bool, data: &Any, origin: &JsString, last_event_id: &JsString, source: &Any, ports: &TypedArray<MessagePort>) -> Undefined {
