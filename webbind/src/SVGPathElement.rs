...
impl FromVal for SVGPathElement {
    fn from_val(v: &Any) -> Self {
        SVGPathElement { inner: SVGGeometryElement::from_val(v) }
    }
...
impl SVGPathElement {
    ...
    pub fn get_path_segment_at_length(&self, distance: f32) -> SVGPathSegment {
        self.inner.call("getPathSegmentAtLength", &[distance.into(), ]).as_::<SVGPathSegment>()
    }
}
impl SVGPathElement {
    ...
    pub fn get_path_data0(&self, ) -> TypedArray<SVGPathSegment> {
        self.inner.call("getPathData", &[]).as_::<TypedArray<SVGPathSegment>>()
    }
    /// The getPathData method.
    /// [`SVGPathElement.getPathData`](https://developer.mozilla.org/en-US/docs/Web/API/SVGPathElement/getPathData)
    pub fn get_path_data1(&self, settings: &SVGPathDataSettings) -> TypedArray<SVGPathSegment> {
        self.inner.call("getPathData", &[settings.into(), ]).as_::<TypedArray<SVGPathSegment>>()
    }
}
impl SVGPathElement {
    ...
    pub fn set_path_data(&self, path_data: &TypedArray<SVGPathSegment>) -> Undefined {
        self.inner.call("setPathData", &[path_data.into(), ]).as_::<Undefined>()
    }
}
