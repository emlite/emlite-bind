...
impl FromVal for Navigator {
    fn from_val(v: &Any) -> Self {
        Navigator { inner: Any::from_val(v) }
    }
...
impl Navigator {
    ...
    pub fn get_battery(&self, ) -> Promise<BatteryManager> {
        self.inner.call("getBattery", &[]).as_::<Promise<BatteryManager>>()
    }
}
impl Navigator {
...
impl Navigator {
    ...
    pub fn request_media_key_system_access(&self, key_system: &JsString, supported_configurations: &TypedArray<MediaKeySystemConfiguration>) -> Promise<MediaKeySystemAccess> {
        self.inner.call("requestMediaKeySystemAccess", &[key_system.into(), supported_configurations.into(), ]).as_::<Promise<MediaKeySystemAccess>>()
    }
}
impl Navigator {
    ...
    pub fn deprecated_replace_in_urn(&self, urn_or_config: &Any, replacements: &Record<JsString, JsString>) -> Promise<Undefined> {
        self.inner.call("deprecatedReplaceInURN", &[urn_or_config.into(), replacements.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Navigator {
    ...
    pub fn deprecated_ur_nto_url0(&self, urn_or_config: &Any) -> Promise<JsString> {
        self.inner.call("deprecatedURNtoURL", &[urn_or_config.into(), ]).as_::<Promise<JsString>>()
    }
    /// The deprecatedURNtoURL method.
    /// [`Navigator.deprecatedURNtoURL`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/deprecatedURNtoURL)
    pub fn deprecated_ur_nto_url1(&self, urn_or_config: &Any, send_reports: bool) -> Promise<JsString> {
        self.inner.call("deprecatedURNtoURL", &[urn_or_config.into(), send_reports.into(), ]).as_::<Promise<JsString>>()
    }
}
impl Navigator {
    ...
    pub fn ad_auction_components(&self, num_ad_components: u16) -> TypedArray<JsString> {
        self.inner.call("adAuctionComponents", &[num_ad_components.into(), ]).as_::<TypedArray<JsString>>()
    }
}
impl Navigator {
    ...
    pub fn get_gamepads(&self, ) -> TypedArray<Gamepad> {
        self.inner.call("getGamepads", &[]).as_::<TypedArray<Gamepad>>()
    }
}
impl Navigator {
...
impl Navigator {
    ...
    pub fn get_installed_related_apps(&self, ) -> Promise<TypedArray<RelatedApplication>> {
        self.inner.call("getInstalledRelatedApps", &[]).as_::<Promise<TypedArray<RelatedApplication>>>()
    }
}
impl Navigator {
    ...
    pub fn query_handwriting_recognizer(&self, constraint: &HandwritingModelConstraint) -> Promise<HandwritingRecognizerQueryResult> {
        self.inner.call("queryHandwritingRecognizer", &[constraint.into(), ]).as_::<Promise<HandwritingRecognizerQueryResult>>()
    }
}
impl Navigator {
    ...
    pub fn create_handwriting_recognizer(&self, constraint: &HandwritingModelConstraint) -> Promise<HandwritingRecognizer> {
        self.inner.call("createHandwritingRecognizer", &[constraint.into(), ]).as_::<Promise<HandwritingRecognizer>>()
    }
}
impl Navigator {
...
impl Navigator {
    ...
    pub fn join_ad_interest_group(&self, group: &AuctionAdInterestGroup) -> Promise<Undefined> {
        self.inner.call("joinAdInterestGroup", &[group.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Navigator {
    ...
    pub fn leave_ad_interest_group0(&self, ) -> Promise<Undefined> {
        self.inner.call("leaveAdInterestGroup", &[]).as_::<Promise<Undefined>>()
    }
    /// The leaveAdInterestGroup method.
    /// [`Navigator.leaveAdInterestGroup`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/leaveAdInterestGroup)
    pub fn leave_ad_interest_group1(&self, group: &AuctionAdInterestGroupKey) -> Promise<Undefined> {
        self.inner.call("leaveAdInterestGroup", &[group.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Navigator {
    ...
    pub fn clear_origin_joined_ad_interest_groups0(&self, owner: &JsString) -> Promise<Undefined> {
        self.inner.call("clearOriginJoinedAdInterestGroups", &[owner.into(), ]).as_::<Promise<Undefined>>()
    }
    /// The clearOriginJoinedAdInterestGroups method.
    /// [`Navigator.clearOriginJoinedAdInterestGroups`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/clearOriginJoinedAdInterestGroups)
    pub fn clear_origin_joined_ad_interest_groups1(&self, owner: &JsString, interest_groups_to_keep: &TypedArray<JsString>) -> Promise<Undefined> {
        self.inner.call("clearOriginJoinedAdInterestGroups", &[owner.into(), interest_groups_to_keep.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Navigator {
    ...
    pub fn run_ad_auction(&self, config: &AuctionAdConfig) -> Promise<Any> {
        self.inner.call("runAdAuction", &[config.into(), ]).as_::<Promise<Any>>()
    }
}
impl Navigator {
...
impl Navigator {
    ...
    pub fn get_interest_group_ad_auction_data0(&self, ) -> Promise<AdAuctionData> {
        self.inner.call("getInterestGroupAdAuctionData", &[]).as_::<Promise<AdAuctionData>>()
    }
    /// The getInterestGroupAdAuctionData method.
    /// [`Navigator.getInterestGroupAdAuctionData`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/getInterestGroupAdAuctionData)
    pub fn get_interest_group_ad_auction_data1(&self, config: &AdAuctionDataConfig) -> Promise<AdAuctionData> {
        self.inner.call("getInterestGroupAdAuctionData", &[config.into(), ]).as_::<Promise<AdAuctionData>>()
    }
}
impl Navigator {
    ...
    pub fn create_auction_nonce(&self, ) -> Promise<JsString> {
        self.inner.call("createAuctionNonce", &[]).as_::<Promise<JsString>>()
    }
}
impl Navigator {
...
impl Navigator {
    ...
    pub fn share1(&self, data: &ShareData) -> Promise<Undefined> {
        self.inner.call("share", &[data.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Navigator {
    /// The canShare method.
...
impl Navigator {
    ...
    pub fn request_midi_access0(&self, ) -> Promise<MIDIAccess> {
        self.inner.call("requestMIDIAccess", &[]).as_::<Promise<MIDIAccess>>()
    }
    /// The requestMIDIAccess method.
    /// [`Navigator.requestMIDIAccess`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/requestMIDIAccess)
    pub fn request_midi_access1(&self, options: &MIDIOptions) -> Promise<MIDIAccess> {
        self.inner.call("requestMIDIAccess", &[options.into(), ]).as_::<Promise<MIDIAccess>>()
    }
}
impl Navigator {
