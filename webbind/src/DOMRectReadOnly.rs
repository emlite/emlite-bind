...
impl FromVal for DOMRectReadOnly {
    fn from_val(v: &emlite::Val) -> Self {
        DOMRectReadOnly { inner: emlite::Val::from_val(v) }
    }
    fn take_ownership(v: emlite::env::Handle) -> Self {
        Self::from_val(&emlite::Val::take_ownership(v))
    }
...
impl DOMRectReadOnly {
    pub fn new0() -> DOMRectReadOnly {
        Self {
            inner: emlite::Val::global("DOMRectReadOnly").new(&[]).as_::<emlite::Val>(),
        }
    }

    pub fn new1(x: f64) -> DOMRectReadOnly {
        Self {
            inner: emlite::Val::global("DOMRectReadOnly").new(&[x.into()]).as_::<emlite::Val>(),
        }
    }

    pub fn new2(x: f64, y: f64) -> DOMRectReadOnly {
        Self {
            inner: emlite::Val::global("DOMRectReadOnly").new(&[x.into(), y.into()]).as_::<emlite::Val>(),
        }
    }

    pub fn new3(x: f64, y: f64, width: f64) -> DOMRectReadOnly {
        Self {
            inner: emlite::Val::global("DOMRectReadOnly").new(&[x.into(), y.into(), width.into()]).as_::<emlite::Val>(),
        }
    }

    pub fn new4(x: f64, y: f64, width: f64, height: f64) -> DOMRectReadOnly {
        Self {
            inner: emlite::Val::global("DOMRectReadOnly").new(&[x.into(), y.into(), width.into(), height.into()]).as_::<emlite::Val>(),
        }
    }
...
impl DOMRectReadOnly {
    pub fn from_rect0() -> DOMRectReadOnly {
        emlite::Val::global("domrectreadonly").call("fromRect", &[]).as_::<DOMRectReadOnly>()
    }

    pub fn from_rect1(other: DOMRectInit) -> DOMRectReadOnly {
        emlite::Val::global("domrectreadonly").call("fromRect", &[other.into(), ]).as_::<DOMRectReadOnly>()
    }
