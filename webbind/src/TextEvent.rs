...
impl TextEvent {
    ...
    /// The initTextEvent method.
    /// [`TextEvent.initTextEvent`](https://developer.mozilla.org/en-US/docs/Web/API/TextEvent/initTextEvent)
    pub fn init_text_event3(&self, type_: &JsString, bubbles: bool, cancelable: bool, view: &Window) -> Undefined {
        self.inner.call("initTextEvent", &[type_.into(), bubbles.into(), cancelable.into(), view.into(), ]).as_::<Undefined>()
    }
    /// The initTextEvent method.
    /// [`TextEvent.initTextEvent`](https://developer.mozilla.org/en-US/docs/Web/API/TextEvent/initTextEvent)
    pub fn init_text_event4(&self, type_: &JsString, bubbles: bool, cancelable: bool, view: &Window, data: &JsString) -> Undefined {
