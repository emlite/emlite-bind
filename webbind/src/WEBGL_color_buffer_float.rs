...
impl FromVal for WEBGL_color_buffer_float {
    fn from_val(v: &emlite::Val) -> Self {
        WEBGL_color_buffer_float { inner: emlite::Val::from_val(v) }
    }
...
impl AsRef<emlite::Val> for WEBGL_color_buffer_float {
    fn as_ref(&self) -> &emlite::Val {
        &self.inner
    }
}
impl AsMut<emlite::Val> for WEBGL_color_buffer_float {
