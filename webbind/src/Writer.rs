...
impl FromVal for Writer {
    fn from_val(v: &emlite::Val) -> Self {
        Writer { inner: emlite::Val::from_val(v) }
    }
    fn take_ownership(v: emlite::env::Handle) -> Self {
        Self::from_val(&emlite::Val::take_ownership(v))
    }
...
impl Writer {
    pub fn create0() -> Promise {
        emlite::Val::global("writer").call("create", &[]).as_::<Promise>()
    }

    pub fn create1(options: WriterCreateOptions) -> Promise {
        emlite::Val::global("writer").call("create", &[options.into(), ]).as_::<Promise>()
    }

}
impl Writer {
    pub fn availability0() -> Promise {
        emlite::Val::global("writer").call("availability", &[]).as_::<Promise>()
    }

    pub fn availability1(options: WriterCreateCoreOptions) -> Promise {
        emlite::Val::global("writer").call("availability", &[options.into(), ]).as_::<Promise>()
    }
...
impl Writer {
    ...
    pub fn write1(&self, input: DOMString, options: WriterWriteOptions) -> Promise {
        self.inner.call("write", &[input.into(), options.into(), ]).as_::<Promise>()
    }
...
impl Writer {
    ...
    pub fn write_streaming1(&self, input: DOMString, options: WriterWriteOptions) -> ReadableStream {
