...
impl FromVal for DigitalGoodsService {
    fn from_val(v: &Any) -> Self {
        DigitalGoodsService { inner: Any::from_val(v) }
    }
...
impl DigitalGoodsService {
    ...
    pub fn get_details(&self, item_ids: &TypedArray<JsString>) -> Promise<TypedArray<ItemDetails>> {
        self.inner.call("getDetails", &[item_ids.into(), ]).as_::<Promise<TypedArray<ItemDetails>>>()
    }
}
impl DigitalGoodsService {
    ...
    pub fn list_purchases(&self, ) -> Promise<TypedArray<PurchaseDetails>> {
        self.inner.call("listPurchases", &[]).as_::<Promise<TypedArray<PurchaseDetails>>>()
    }
}
impl DigitalGoodsService {
    ...
    pub fn list_purchase_history(&self, ) -> Promise<TypedArray<PurchaseDetails>> {
        self.inner.call("listPurchaseHistory", &[]).as_::<Promise<TypedArray<PurchaseDetails>>>()
    }
}
impl DigitalGoodsService {
    /// The consume method.
    ...
    pub fn consume(&self, purchase_token: &JsString) -> Promise<Undefined> {
        self.inner.call("consume", &[purchase_token.into(), ]).as_::<Promise<Undefined>>()
    }
}
