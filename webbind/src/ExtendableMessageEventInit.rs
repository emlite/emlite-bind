...
impl FromVal for ExtendableMessageEventInit {
    fn from_val(v: &Any) -> Self {
        ExtendableMessageEventInit { inner: v.clone() }
    }
...
impl core::ops::Deref for ExtendableMessageEventInit {
    type Target = Any;
...
impl core::ops::DerefMut for ExtendableMessageEventInit {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.inner
    }
}

impl AsRef<Any> for ExtendableMessageEventInit {
    fn as_ref(&self) -> &Any {
        &self.inner
    }
}

impl AsMut<Any> for ExtendableMessageEventInit {
    fn as_mut(&mut self) -> &mut Any {
        &mut self.inner
    }
}

impl From<ExtendableMessageEventInit> for Any {
    fn from(s: ExtendableMessageEventInit) -> Any {
