...
impl FromVal for IDBKeyRange {
    fn from_val(v: &Any) -> Self {
        IDBKeyRange { inner: Any::from_val(v) }
    }
...
impl IDBKeyRange {
    ...
    pub fn only(value: &Any) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("only", &[value.into(), ]).as_::<IDBKeyRange>()
    }
}
impl IDBKeyRange {
    ...
    pub fn lower_bound0(lower: &Any) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("lowerBound", &[lower.into(), ]).as_::<IDBKeyRange>()
    }
    /// The lowerBound method.
    /// [`IDBKeyRange.lowerBound`](https://developer.mozilla.org/en-US/docs/Web/API/IDBKeyRange/lowerBound)
    pub fn lower_bound1(lower: &Any, open: bool) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("lowerBound", &[lower.into(), open.into(), ]).as_::<IDBKeyRange>()
    }
}
impl IDBKeyRange {
    ...
    pub fn upper_bound0(upper: &Any) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("upperBound", &[upper.into(), ]).as_::<IDBKeyRange>()
    }
    /// The upperBound method.
    /// [`IDBKeyRange.upperBound`](https://developer.mozilla.org/en-US/docs/Web/API/IDBKeyRange/upperBound)
    pub fn upper_bound1(upper: &Any, open: bool) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("upperBound", &[upper.into(), open.into(), ]).as_::<IDBKeyRange>()
    }
}
impl IDBKeyRange {
    /// The bound method.
    ...
    pub fn bound0(lower: &Any, upper: &Any) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("bound", &[lower.into(), upper.into(), ]).as_::<IDBKeyRange>()
    }
    /// The bound method.
    /// [`IDBKeyRange.bound`](https://developer.mozilla.org/en-US/docs/Web/API/IDBKeyRange/bound)
    pub fn bound1(lower: &Any, upper: &Any, lower_open: bool) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("bound", &[lower.into(), upper.into(), lower_open.into(), ]).as_::<IDBKeyRange>()
    }
    /// The bound method.
    /// [`IDBKeyRange.bound`](https://developer.mozilla.org/en-US/docs/Web/API/IDBKeyRange/bound)
    pub fn bound2(lower: &Any, upper: &Any, lower_open: bool, upper_open: bool) -> IDBKeyRange {
        Any::global("IDBKeyRange").call("bound", &[lower.into(), upper.into(), lower_open.into(), upper_open.into(), ]).as_::<IDBKeyRange>()
    }
}
impl IDBKeyRange {
    /// The includes method.
