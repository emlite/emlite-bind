...
impl FromVal for CustomElementRegistry {
    fn from_val(v: &Any) -> Self {
        CustomElementRegistry { inner: Any::from_val(v) }
    }
...
impl CustomElementRegistry {
    ...
    /// The define method.
    /// [`CustomElementRegistry.define`](https://developer.mozilla.org/en-US/docs/Web/API/CustomElementRegistry/define)
    pub fn define1(&self, name: &JsString, constructor: &Function, options: &ElementDefinitionOptions) -> Undefined {
...
impl CustomElementRegistry {
    ...
    pub fn get_name(&self, constructor: &Function) -> JsString {
        self.inner.call("getName", &[constructor.into(), ]).as_::<JsString>()
    }
}
impl CustomElementRegistry {
    ...
    pub fn when_defined(&self, name: &JsString) -> Promise<Function> {
        self.inner.call("whenDefined", &[name.into(), ]).as_::<Promise<Function>>()
    }
}
impl CustomElementRegistry {
    /// The upgrade method.
