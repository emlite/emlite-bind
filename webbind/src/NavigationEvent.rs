...
impl std::ops::Deref for NavigationEvent {
    type Target = UIEvent;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for NavigationEvent {
...
impl NavigationEvent {
    pub fn new0(type_: jsbind::DOMString) -> NavigationEvent {
        Self {
    ...
    pub fn new1(type_: jsbind::DOMString, event_init_dict: jsbind::Any) -> NavigationEvent {
        Self {
            inner: emlite::Val::global("NavigationEvent")
