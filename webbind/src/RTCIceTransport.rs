...
impl RTCIceTransport {
    pub fn get_local_candidates(&self, ) -> Sequence<RTCIceCandidate> {
        self.inner.call("getLocalCandidates", &[]).as_::<Sequence<RTCIceCandidate>>()
    }

}
impl RTCIceTransport {
    pub fn get_remote_candidates(&self, ) -> Sequence<RTCIceCandidate> {
        self.inner.call("getRemoteCandidates", &[]).as_::<Sequence<RTCIceCandidate>>()
    }
...
impl RTCIceTransport {
    pub fn new() -> RTCIceTransport {
        Self {
            inner: emlite::Val::global("RTCIceTransport").new(&[]).as_::<EventTarget>(),
        }
    }
