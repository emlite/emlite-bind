...
impl FromVal for GPUBuffer {
    fn from_val(v: &emlite::Val) -> Self {
        GPUBuffer { inner: emlite::Val::from_val(v) }
    }
...
impl GPUBuffer {
    ...
    pub fn map_async1(&self, mode: Any, offset: Any) -> Promise {
        self.inner.call("mapAsync", &[mode.into(), offset.into(), ]).as_::<Promise>()
    }

    pub fn map_async2(&self, mode: Any, offset: Any, size: Any) -> Promise {
        self.inner.call("mapAsync", &[mode.into(), offset.into(), size.into(), ]).as_::<Promise>()
    }
