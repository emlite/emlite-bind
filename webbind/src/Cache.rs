...
impl Cache {
    /// The match method.
    /// [`Cache.match`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/match)
    pub fn match_with_options(&self, request: &Any, options: &CacheQueryOptions) -> Promise<Any> {
        self.inner
...
impl Cache {
    ...
    pub fn match_all(&self) -> Promise<TypedArray<Response>> {
        self.inner
            .call("matchAll", &[])
...
impl Cache {
    /// The matchAll method.
    /// [`Cache.matchAll`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/matchAll)
    pub fn match_all_with_request(&self, request: &Any) -> Promise<TypedArray<Response>> {
        self.inner
...
impl Cache {
    ...
    pub fn delete(&self, request: &Any) -> Promise<bool> {
        self.inner
...
impl Cache {
    /// The delete method.
    /// [`Cache.delete`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/delete)
    pub fn delete_with_options(&self, request: &Any, options: &CacheQueryOptions) -> Promise<bool> {
        self.inner
...
impl Cache {
    ...
    pub fn keys(&self) -> Promise<TypedArray<Request>> {
        self.inner
            .call("keys", &[])
...
impl Cache {
    /// The keys method.
    /// [`Cache.keys`](https://developer.mozilla.org/en-US/docs/Web/API/Cache/keys)
    pub fn keys_with_request(&self, request: &Any) -> Promise<TypedArray<Request>> {
        self.inner
