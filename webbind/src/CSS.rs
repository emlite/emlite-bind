...
pub fn escape(ident: &JsString) -> JsString {
    Any::global("CSS").call("escape", &[ident.into(), ]).as_::<JsString>()
}

/// The supports function from the CSS namespace.
pub fn supports(condition_text: &JsString) -> bool {
    Any::global("CSS").call("supports", &[condition_text.into(), ]).as_::<bool>()
}

/// The parseStylesheet function from the CSS namespace.
pub fn parse_stylesheet0(css: &Any) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseStylesheet", &[css.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseStylesheet function from the CSS namespace.
pub fn parse_stylesheet1(css: &Any, options: &CSSParserOptions) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseStylesheet", &[css.into(), options.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseRuleList function from the CSS namespace.
pub fn parse_rule_list0(css: &Any) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseRuleList", &[css.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseRuleList function from the CSS namespace.
pub fn parse_rule_list1(css: &Any, options: &CSSParserOptions) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseRuleList", &[css.into(), options.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseRule function from the CSS namespace.
pub fn parse_rule0(css: &Any) -> Promise<CSSParserRule> {
    Any::global("CSS").call("parseRule", &[css.into(), ]).as_::<Promise<CSSParserRule>>()
}

/// The parseRule function from the CSS namespace.
pub fn parse_rule1(css: &Any, options: &CSSParserOptions) -> Promise<CSSParserRule> {
    Any::global("CSS").call("parseRule", &[css.into(), options.into(), ]).as_::<Promise<CSSParserRule>>()
}
...
pub fn parse_declaration_list0(css: &Any) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseDeclarationList", &[css.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseDeclarationList function from the CSS namespace.
pub fn parse_declaration_list1(css: &Any, options: &CSSParserOptions) -> Promise<TypedArray<CSSParserRule>> {
    Any::global("CSS").call("parseDeclarationList", &[css.into(), options.into(), ]).as_::<Promise<TypedArray<CSSParserRule>>>()
}

/// The parseDeclaration function from the CSS namespace.
pub fn parse_declaration0(css: &JsString) -> CSSParserDeclaration {
    Any::global("CSS").call("parseDeclaration", &[css.into(), ]).as_::<CSSParserDeclaration>()
}

/// The parseDeclaration function from the CSS namespace.
pub fn parse_declaration1(css: &JsString, options: &CSSParserOptions) -> CSSParserDeclaration {
    Any::global("CSS").call("parseDeclaration", &[css.into(), options.into(), ]).as_::<CSSParserDeclaration>()
}

/// The parseValue function from the CSS namespace.
pub fn parse_value(css: &JsString) -> Any {
    Any::global("CSS").call("parseValue", &[css.into(), ]).as_::<Any>()
}

/// The parseValueList function from the CSS namespace.
pub fn parse_value_list(css: &JsString) -> TypedArray<Any> {
    Any::global("CSS").call("parseValueList", &[css.into(), ]).as_::<TypedArray<Any>>()
}
