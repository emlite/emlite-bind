...
impl FromVal for IntersectionObserverEntry {
    fn from_val(v: &emlite::Val) -> Self {
        IntersectionObserverEntry { inner: emlite::Val::from_val(v) }
    }
...
impl IntersectionObserverEntry {
    pub fn new(intersection_observer_entry_init: Any) -> IntersectionObserverEntry {
        Self {
            inner: emlite::Val::global("IntersectionObserverEntry").new(&[intersection_observer_entry_init.into()]).as_::<emlite::Val>(),
        }
    }
