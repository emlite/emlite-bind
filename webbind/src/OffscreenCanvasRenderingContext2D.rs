...
impl AsRef<emlite::Val> for OffscreenCanvasRenderingContext2D {
    fn as_ref(&self) -> &emlite::Val {
        &self.inner
    }
}
impl AsMut<emlite::Val> for OffscreenCanvasRenderingContext2D {
    fn as_mut(&mut self) -> &mut emlite::Val {
        &mut self.inner
    }
}
impl From<OffscreenCanvasRenderingContext2D> for emlite::Val {
    fn from(s: OffscreenCanvasRenderingContext2D) -> emlite::Val {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn save(&self) -> jsbind::Undefined {
        self.inner.call("save", &[]).as_::<jsbind::Undefined>()
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn restore(&self) -> jsbind::Undefined {
        self.inner.call("restore", &[]).as_::<jsbind::Undefined>()
    }
}
impl OffscreenCanvasRenderingContext2D {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn scale(&self, x: f64, y: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn rotate(&self, angle: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn translate(&self, x: f64, y: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn transform(&self, a: f64, b: f64, c: f64, d: f64, e: f64, f: f64) -> jsbind::Undefined {
        self.inner
            .call(
                "transform",
...
impl OffscreenCanvasRenderingContext2D {
    pub fn reset_transform(&self) -> jsbind::Undefined {
        self.inner
            .call("resetTransform", &[])
            .as_::<jsbind::Undefined>()
    }
...
impl OffscreenCanvasRenderingContext2D {
    pub fn global_composite_operation(&self) -> jsbind::DOMString {
        self.inner
            .get("globalCompositeOperation")
            .as_::<jsbind::DOMString>()
    }

    pub fn set_global_composite_operation(&mut self, value: jsbind::DOMString) {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn stroke_style(&self) -> jsbind::Any {
        self.inner.get("strokeStyle").as_::<jsbind::Any>()
    }

    pub fn set_stroke_style(&mut self, value: jsbind::Any) {
        self.inner.set("strokeStyle", value);
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn fill_style(&self) -> jsbind::Any {
        self.inner.get("fillStyle").as_::<jsbind::Any>()
    }

    pub fn set_fill_style(&mut self, value: jsbind::Any) {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn shadow_color(&self) -> jsbind::DOMString {
        self.inner.get("shadowColor").as_::<jsbind::DOMString>()
    }

    pub fn set_shadow_color(&mut self, value: jsbind::DOMString) {
        self.inner.set("shadowColor", value);
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn filter(&self) -> jsbind::DOMString {
        self.inner.get("filter").as_::<jsbind::DOMString>()
    }

    pub fn set_filter(&mut self, value: jsbind::DOMString) {
        self.inner.set("filter", value);
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn clear_rect(&self, x: f64, y: f64, w: f64, h: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn fill_rect(&self, x: f64, y: f64, w: f64, h: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn stroke_rect(&self, x: f64, y: f64, w: f64, h: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn begin_path(&self) -> jsbind::Undefined {
        self.inner.call("beginPath", &[]).as_::<jsbind::Undefined>()
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn fill0(&self, path: Path2D) -> jsbind::Undefined {
        self.inner
            .call("fill", &[path.into()])
            .as_::<jsbind::Undefined>()
    }

    pub fn fill1(&self, path: Path2D, fill_rule: CanvasFillRule) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn stroke(&self, path: Path2D) -> jsbind::Undefined {
        self.inner
            .call("stroke", &[path.into()])
            .as_::<jsbind::Undefined>()
    }
}
impl OffscreenCanvasRenderingContext2D {
    pub fn clip0(&self, path: Path2D) -> jsbind::Undefined {
        self.inner
            .call("clip", &[path.into()])
            .as_::<jsbind::Undefined>()
    }

    pub fn clip1(&self, path: Path2D, fill_rule: CanvasFillRule) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn fill_text0(&self, text: jsbind::DOMString, x: f64, y: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn stroke_text0(&self, text: jsbind::DOMString, x: f64, y: f64) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn measure_text(&self, text: jsbind::DOMString) -> TextMetrics {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn set_line_dash(&self, segments: jsbind::Sequence<f64>) -> jsbind::Undefined {
        self.inner
...
impl OffscreenCanvasRenderingContext2D {
    pub fn get_line_dash(&self) -> jsbind::Sequence<f64> {
        self.inner
            .call("getLineDash", &[])
            .as_::<jsbind::Sequence<f64>>()
    }
}
impl OffscreenCanvasRenderingContext2D {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn font(&self) -> jsbind::DOMString {
        self.inner.get("font").as_::<jsbind::DOMString>()
    }

    pub fn set_font(&mut self, value: jsbind::DOMString) {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn letter_spacing(&self) -> jsbind::DOMString {
        self.inner.get("letterSpacing").as_::<jsbind::DOMString>()
    }

    pub fn set_letter_spacing(&mut self, value: jsbind::DOMString) {
...
impl OffscreenCanvasRenderingContext2D {
    pub fn word_spacing(&self) -> jsbind::DOMString {
        self.inner.get("wordSpacing").as_::<jsbind::DOMString>()
    }

    pub fn set_word_spacing(&mut self, value: jsbind::DOMString) {
