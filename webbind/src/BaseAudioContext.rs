...
impl BaseAudioContext {
    pub fn create_iir_filter(&self, feedforward: Sequence<f64>, feedback: Sequence<f64>) -> IIRFilterNode {
...
impl BaseAudioContext {
    ...
    pub fn create_periodic_wave1(&self, real: Sequence<f32>, imag: Sequence<f32>, constraints: PeriodicWaveConstraints) -> PeriodicWave {
...
impl BaseAudioContext {
    pub fn decode_audio_data0(&self, audio_data: ArrayBuffer) -> Promise {
        self.inner.call("decodeAudioData", &[audio_data.into(), ]).as_::<Promise>()
    }

    pub fn decode_audio_data1(&self, audio_data: ArrayBuffer, success_callback: Function) -> Promise {
        self.inner.call("decodeAudioData", &[audio_data.into(), success_callback.into(), ]).as_::<Promise>()
    }

    pub fn decode_audio_data2(&self, audio_data: ArrayBuffer, success_callback: Function, error_callback: Function) -> Promise {
        self.inner.call("decodeAudioData", &[audio_data.into(), success_callback.into(), error_callback.into(), ]).as_::<Promise>()
    }
