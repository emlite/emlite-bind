...
impl FromVal for BaseAudioContext {
    fn from_val(v: &Any) -> Self {
        BaseAudioContext { inner: EventTarget::from_val(v) }
    }
...
impl BaseAudioContext {
    ...
    pub fn create_biquad_filter(&self, ) -> BiquadFilterNode {
        self.inner.call("createBiquadFilter", &[]).as_::<BiquadFilterNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_buffer(&self, number_of_channels: u32, length: u32, sample_rate: f32) -> AudioBuffer {
        self.inner.call("createBuffer", &[number_of_channels.into(), length.into(), sample_rate.into(), ]).as_::<AudioBuffer>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_buffer_source(&self, ) -> AudioBufferSourceNode {
        self.inner.call("createBufferSource", &[]).as_::<AudioBufferSourceNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_channel_merger0(&self, ) -> ChannelMergerNode {
        self.inner.call("createChannelMerger", &[]).as_::<ChannelMergerNode>()
    }
    /// The createChannelMerger method.
    /// [`BaseAudioContext.createChannelMerger`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createChannelMerger)
    pub fn create_channel_merger1(&self, number_of_inputs: u32) -> ChannelMergerNode {
        self.inner.call("createChannelMerger", &[number_of_inputs.into(), ]).as_::<ChannelMergerNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_channel_splitter0(&self, ) -> ChannelSplitterNode {
        self.inner.call("createChannelSplitter", &[]).as_::<ChannelSplitterNode>()
    }
    /// The createChannelSplitter method.
    /// [`BaseAudioContext.createChannelSplitter`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createChannelSplitter)
    pub fn create_channel_splitter1(&self, number_of_outputs: u32) -> ChannelSplitterNode {
        self.inner.call("createChannelSplitter", &[number_of_outputs.into(), ]).as_::<ChannelSplitterNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_constant_source(&self, ) -> ConstantSourceNode {
        self.inner.call("createConstantSource", &[]).as_::<ConstantSourceNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_convolver(&self, ) -> ConvolverNode {
        self.inner.call("createConvolver", &[]).as_::<ConvolverNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_delay1(&self, max_delay_time: f64) -> DelayNode {
        self.inner.call("createDelay", &[max_delay_time.into(), ]).as_::<DelayNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_dynamics_compressor(&self, ) -> DynamicsCompressorNode {
        self.inner.call("createDynamicsCompressor", &[]).as_::<DynamicsCompressorNode>()
    }
}
impl BaseAudioContext {
...
impl BaseAudioContext {
    ...
    pub fn create_iir_filter(&self, feedforward: TypedArray<f64>, feedback: TypedArray<f64>) -> IIRFilterNode {
        self.inner.call("createIIRFilter", &[feedforward.into(), feedback.into(), ]).as_::<IIRFilterNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_oscillator(&self, ) -> OscillatorNode {
        self.inner.call("createOscillator", &[]).as_::<OscillatorNode>()
    }
}
impl BaseAudioContext {
...
impl BaseAudioContext {
    ...
    pub fn create_periodic_wave0(&self, real: TypedArray<f32>, imag: TypedArray<f32>) -> PeriodicWave {
        self.inner.call("createPeriodicWave", &[real.into(), imag.into(), ]).as_::<PeriodicWave>()
    }
    /// The createPeriodicWave method.
    /// [`BaseAudioContext.createPeriodicWave`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createPeriodicWave)
    pub fn create_periodic_wave1(&self, real: TypedArray<f32>, imag: TypedArray<f32>, constraints: &PeriodicWaveConstraints) -> PeriodicWave {
        self.inner.call("createPeriodicWave", &[real.into(), imag.into(), constraints.into(), ]).as_::<PeriodicWave>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_script_processor0(&self, ) -> ScriptProcessorNode {
        self.inner.call("createScriptProcessor", &[]).as_::<ScriptProcessorNode>()
    }
    /// The createScriptProcessor method.
    /// [`BaseAudioContext.createScriptProcessor`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createScriptProcessor)
    pub fn create_script_processor1(&self, buffer_size: u32) -> ScriptProcessorNode {
        self.inner.call("createScriptProcessor", &[buffer_size.into(), ]).as_::<ScriptProcessorNode>()
    }
    /// The createScriptProcessor method.
    /// [`BaseAudioContext.createScriptProcessor`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createScriptProcessor)
    pub fn create_script_processor2(&self, buffer_size: u32, number_of_input_channels: u32) -> ScriptProcessorNode {
        self.inner.call("createScriptProcessor", &[buffer_size.into(), number_of_input_channels.into(), ]).as_::<ScriptProcessorNode>()
    }
    /// The createScriptProcessor method.
    /// [`BaseAudioContext.createScriptProcessor`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/createScriptProcessor)
    pub fn create_script_processor3(&self, buffer_size: u32, number_of_input_channels: u32, number_of_output_channels: u32) -> ScriptProcessorNode {
        self.inner.call("createScriptProcessor", &[buffer_size.into(), number_of_input_channels.into(), number_of_output_channels.into(), ]).as_::<ScriptProcessorNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_stereo_panner(&self, ) -> StereoPannerNode {
        self.inner.call("createStereoPanner", &[]).as_::<StereoPannerNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn create_wave_shaper(&self, ) -> WaveShaperNode {
        self.inner.call("createWaveShaper", &[]).as_::<WaveShaperNode>()
    }
}
impl BaseAudioContext {
    ...
    pub fn decode_audio_data0(&self, audio_data: &ArrayBuffer) -> Promise<AudioBuffer> {
        self.inner.call("decodeAudioData", &[audio_data.into(), ]).as_::<Promise<AudioBuffer>>()
    }
    /// The decodeAudioData method.
    /// [`BaseAudioContext.decodeAudioData`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/decodeAudioData)
    pub fn decode_audio_data1(&self, audio_data: &ArrayBuffer, success_callback: &Function) -> Promise<AudioBuffer> {
        self.inner.call("decodeAudioData", &[audio_data.into(), success_callback.into(), ]).as_::<Promise<AudioBuffer>>()
    }
    /// The decodeAudioData method.
    /// [`BaseAudioContext.decodeAudioData`](https://developer.mozilla.org/en-US/docs/Web/API/BaseAudioContext/decodeAudioData)
    pub fn decode_audio_data2(&self, audio_data: &ArrayBuffer, success_callback: &Function, error_callback: &Function) -> Promise<AudioBuffer> {
        self.inner.call("decodeAudioData", &[audio_data.into(), success_callback.into(), error_callback.into(), ]).as_::<Promise<AudioBuffer>>()
    }
}
