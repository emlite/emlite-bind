...
impl FromVal for WEBGL_compressed_texture_s3tc_srgb {
    fn from_val(v: &emlite::Val) -> Self {
        WEBGL_compressed_texture_s3tc_srgb { inner: emlite::Val::from_val(v) }
    }
...
impl AsRef<emlite::Val> for WEBGL_compressed_texture_s3tc_srgb {
    fn as_ref(&self) -> &emlite::Val {
        &self.inner
    }
}
impl AsMut<emlite::Val> for WEBGL_compressed_texture_s3tc_srgb {
