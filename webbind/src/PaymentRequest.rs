...
impl FromVal for PaymentRequest {
    fn from_val(v: &Any) -> Self {
        PaymentRequest { inner: EventTarget::from_val(v) }
    }
...
impl PaymentRequest {
    ...
    pub fn new0(method_data: &TypedArray<PaymentMethodData>, details: &PaymentDetailsInit) -> PaymentRequest {
        Self {
            inner: Any::global("PaymentRequest").new(&[method_data.into(), details.into()]).as_::<EventTarget>(),
        }
    }

    /// The `new PaymentRequest(..)` constructor, creating a new PaymentRequest instance
    pub fn new1(method_data: &TypedArray<PaymentMethodData>, details: &PaymentDetailsInit, options: &PaymentOptions) -> PaymentRequest {
        Self {
            inner: Any::global("PaymentRequest").new(&[method_data.into(), details.into(), options.into()]).as_::<EventTarget>(),
        }
    }
...
impl PaymentRequest {
    ...
    pub fn show0(&self, ) -> Promise<PaymentResponse> {
        self.inner.call("show", &[]).as_::<Promise<PaymentResponse>>()
    }
    /// The show method.
    /// [`PaymentRequest.show`](https://developer.mozilla.org/en-US/docs/Web/API/PaymentRequest/show)
    pub fn show1(&self, details_promise: &Promise<PaymentDetailsUpdate>) -> Promise<PaymentResponse> {
        self.inner.call("show", &[details_promise.into(), ]).as_::<Promise<PaymentResponse>>()
    }
}
impl PaymentRequest {
    /// The abort method.
...
impl PaymentRequest {
    ...
    pub fn can_make_payment(&self, ) -> Promise<bool> {
        self.inner.call("canMakePayment", &[]).as_::<Promise<bool>>()
    }
}
impl PaymentRequest {
...
impl PaymentRequest {
    ...
    pub fn secure_payment_confirmation_availability() -> Promise<SecurePaymentConfirmationAvailability> {
        Any::global("PaymentRequest").call("securePaymentConfirmationAvailability", &[]).as_::<Promise<SecurePaymentConfirmationAvailability>>()
    }
}
