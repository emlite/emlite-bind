...
impl Event {
    pub fn new0(type_: jsbind::DOMString) -> Event {
        Self {
    ...
    pub fn new1(type_: jsbind::DOMString, event_init_dict: jsbind::Any) -> Event {
        Self {
            inner: emlite::Val::global("Event")
...
impl Event {
    pub fn composed_path(&self) -> jsbind::Sequence<EventTarget> {
        self.inner
            .call("composedPath", &[])
            .as_::<jsbind::Sequence<EventTarget>>()
    }
}
impl Event {
...
impl Event {
    pub fn stop_propagation(&self) -> jsbind::Undefined {
        self.inner
...
impl Event {
    pub fn stop_immediate_propagation(&self) -> jsbind::Undefined {
        self.inner
...
impl Event {
    pub fn prevent_default(&self) -> jsbind::Undefined {
        self.inner
            .call("preventDefault", &[])
            .as_::<jsbind::Undefined>()
    }
...
impl Event {
    pub fn time_stamp(&self) -> jsbind::Any {
        self.inner.get("timeStamp").as_::<jsbind::Any>()
    }
}
impl Event {
    pub fn init_event0(&self, type_: jsbind::DOMString) -> jsbind::Undefined {
        self.inner
            .call("initEvent", &[type_.into()])
            .as_::<jsbind::Undefined>()
    }

    pub fn init_event1(&self, type_: jsbind::DOMString, bubbles: bool) -> jsbind::Undefined {
        self.inner
