...
impl std::ops::Deref for ContentVisibilityAutoStateChangeEvent {
    type Target = Event;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for ContentVisibilityAutoStateChangeEvent {
...
impl ContentVisibilityAutoStateChangeEvent {
    pub fn new0(type_: jsbind::DOMString) -> ContentVisibilityAutoStateChangeEvent {
        Self {
