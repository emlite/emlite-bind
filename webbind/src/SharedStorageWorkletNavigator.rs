...
impl core::ops::Deref for SharedStorageWorkletNavigator {
    type Target = Any;
...
impl core::ops::DerefMut for SharedStorageWorkletNavigator {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.inner
    }
}

impl AsRef<Any> for SharedStorageWorkletNavigator {
    fn as_ref(&self) -> &Any {
        &self.inner
    }
}
...
impl From<SharedStorageWorkletNavigator> for Any {
    fn from(s: SharedStorageWorkletNavigator) -> Any {
