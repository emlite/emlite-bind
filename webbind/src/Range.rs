...
impl Range {
    pub fn set_start(&self, node: Node, offset: u32) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn set_end(&self, node: Node, offset: u32) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn set_start_before(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn set_start_after(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn set_end_before(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn set_end_after(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn collapse0(&self) -> jsbind::Undefined {
        self.inner.call("collapse", &[]).as_::<jsbind::Undefined>()
    }

    pub fn collapse1(&self, to_start: bool) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn select_node(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn select_node_contents(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn delete_contents(&self) -> jsbind::Undefined {
        self.inner
            .call("deleteContents", &[])
            .as_::<jsbind::Undefined>()
    }
...
impl Range {
    pub fn insert_node(&self, node: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn surround_contents(&self, new_parent: Node) -> jsbind::Undefined {
        self.inner
...
impl Range {
    pub fn create_contextual_fragment(&self, string: jsbind::Any) -> DocumentFragment {
        self.inner
