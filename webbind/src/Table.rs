...
impl Table {
    pub fn new0(descriptor: jsbind::Any) -> Table {
        Self {
    ...
    pub fn new1(descriptor: jsbind::Any, value: jsbind::Any) -> Table {
        Self {
            inner: emlite::Val::global("Table")
...
impl Table {
    ...
    pub fn grow1(&self, delta: u32, value: jsbind::Any) -> u32 {
        self.inner
...
impl Table {
    pub fn get(&self, index: u32) -> jsbind::Any {
        self.inner.call("get", &[index.into()]).as_::<jsbind::Any>()
    }
}
impl Table {
    pub fn set0(&self, index: u32) -> jsbind::Undefined {
        self.inner
            .call("set", &[index.into()])
            .as_::<jsbind::Undefined>()
    }

    pub fn set1(&self, index: u32, value: jsbind::Any) -> jsbind::Undefined {
        self.inner
