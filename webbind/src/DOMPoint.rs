...
impl DOMPoint {
    pub fn new0() -> DOMPoint {
        Self {
            inner: emlite::Val::global("DOMPoint").new(&[]).as_::<DOMPointReadOnly>(),
        }
    }

    pub fn new1(x: f64) -> DOMPoint {
        Self {
            inner: emlite::Val::global("DOMPoint").new(&[x.into()]).as_::<DOMPointReadOnly>(),
        }
    }

    pub fn new2(x: f64, y: f64) -> DOMPoint {
        Self {
            inner: emlite::Val::global("DOMPoint").new(&[x.into(), y.into()]).as_::<DOMPointReadOnly>(),
        }
    }

    pub fn new3(x: f64, y: f64, z: f64) -> DOMPoint {
        Self {
            inner: emlite::Val::global("DOMPoint").new(&[x.into(), y.into(), z.into()]).as_::<DOMPointReadOnly>(),
        }
    }

    pub fn new4(x: f64, y: f64, z: f64, w: f64) -> DOMPoint {
        Self {
            inner: emlite::Val::global("DOMPoint").new(&[x.into(), y.into(), z.into(), w.into()]).as_::<DOMPointReadOnly>(),
        }
    }
...
impl DOMPoint {
    pub fn from_point0() -> DOMPoint {
        emlite::Val::global("dompoint").call("fromPoint", &[]).as_::<DOMPoint>()
    }

    pub fn from_point1(other: DOMPointInit) -> DOMPoint {
        emlite::Val::global("dompoint").call("fromPoint", &[other.into(), ]).as_::<DOMPoint>()
    }
