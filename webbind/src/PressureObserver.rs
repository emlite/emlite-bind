...
impl std::ops::Deref for PressureObserverOptions {
    type Target = emlite::Val;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for PressureObserverOptions {
...
impl std::ops::Deref for PressureObserver {
    type Target = emlite::Val;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for PressureObserver {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.inner
    }
}
...
impl PressureObserver {
    pub fn observe0(&self, source: PressureSource) -> jsbind::Promise {
        self.inner
...
impl PressureObserver {
    pub fn unobserve(&self, source: PressureSource) -> jsbind::Undefined {
        self.inner
...
impl PressureObserver {
    pub fn take_records(&self) -> jsbind::Sequence<PressureRecord> {
        self.inner
            .call("takeRecords", &[])
            .as_::<jsbind::Sequence<PressureRecord>>()
    }
}
impl PressureObserver {
    pub fn known_sources() -> jsbind::FrozenArray<PressureSource> {
        emlite::Val::global("pressureobserver")
            .get("knownSources")
            .as_::<jsbind::FrozenArray<PressureSource>>()
    }
}
