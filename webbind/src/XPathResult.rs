...
impl std::ops::Deref for XPathResult {
    type Target = emlite::Val;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for XPathResult {
...
impl XPathResult {
    pub fn string_value(&self) -> jsbind::DOMString {
        self.inner.get("stringValue").as_::<jsbind::DOMString>()
    }
}
impl XPathResult {
