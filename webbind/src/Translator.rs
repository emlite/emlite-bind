...
impl FromVal for Translator {
    fn from_val(v: &Any) -> Self {
        Translator { inner: Any::from_val(v) }
    }
...
impl Translator {
    ...
    pub fn create(options: &TranslatorCreateOptions) -> Promise<Translator> {
        Any::global("Translator").call("create", &[options.into(), ]).as_::<Promise<Translator>>()
    }
}
impl Translator {
    ...
    pub fn availability(options: &TranslatorCreateCoreOptions) -> Promise<Availability> {
        Any::global("Translator").call("availability", &[options.into(), ]).as_::<Promise<Availability>>()
    }
}
impl Translator {
    ...
    pub fn translate0(&self, input: &JsString) -> Promise<JsString> {
        self.inner.call("translate", &[input.into(), ]).as_::<Promise<JsString>>()
    }
    /// The translate method.
    /// [`Translator.translate`](https://developer.mozilla.org/en-US/docs/Web/API/Translator/translate)
    pub fn translate1(&self, input: &JsString, options: &TranslatorTranslateOptions) -> Promise<JsString> {
        self.inner.call("translate", &[input.into(), options.into(), ]).as_::<Promise<JsString>>()
    }
}
impl Translator {
    ...
    /// The translateStreaming method.
    /// [`Translator.translateStreaming`](https://developer.mozilla.org/en-US/docs/Web/API/Translator/translateStreaming)
    pub fn translate_streaming1(&self, input: &JsString, options: &TranslatorTranslateOptions) -> ReadableStream {
...
impl Translator {
    ...
    /// The measureInputUsage method.
    /// [`Translator.measureInputUsage`](https://developer.mozilla.org/en-US/docs/Web/API/Translator/measureInputUsage)
    pub fn measure_input_usage1(&self, input: &JsString, options: &TranslatorTranslateOptions) -> Promise<f64> {
