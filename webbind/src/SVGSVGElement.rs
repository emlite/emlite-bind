...
impl SVGSVGElement {
    pub fn deselect_all(&self) -> jsbind::Undefined {
        self.inner
            .call("deselectAll", &[])
...
impl SVGSVGElement {
    pub fn unsuspend_redraw(&self, suspend_handle_id: u32) -> jsbind::Undefined {
        self.inner
...
impl SVGSVGElement {
    pub fn unsuspend_redraw_all(&self) -> jsbind::Undefined {
        self.inner
...
impl SVGSVGElement {
    pub fn force_redraw(&self) -> jsbind::Undefined {
        self.inner
            .call("forceRedraw", &[])
            .as_::<jsbind::Undefined>()
    }
...
impl SVGSVGElement {
    pub fn pause_animations(&self) -> jsbind::Undefined {
        self.inner
...
impl SVGSVGElement {
    pub fn unpause_animations(&self) -> jsbind::Undefined {
        self.inner
            .call("unpauseAnimations", &[])
            .as_::<jsbind::Undefined>()
    }
}
impl SVGSVGElement {
...
impl SVGSVGElement {
    pub fn set_current_time(&self, seconds: f32) -> jsbind::Undefined {
        self.inner
