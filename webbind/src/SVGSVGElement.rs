...
impl FromVal for SVGSVGElement {
    fn from_val(v: &emlite::Val) -> Self {
        SVGSVGElement { inner: SVGGraphicsElement::from_val(v) }
    }
    fn take_ownership(v: emlite::env::Handle) -> Self {
        Self::from_val(&emlite::Val::take_ownership(v))
    }
...
impl SVGSVGElement {
    pub fn get_intersection_list(&self, rect: DOMRectReadOnly, reference_element: SVGElement) -> NodeList {
        self.inner.call("getIntersectionList", &[rect.into(), reference_element.into(), ]).as_::<NodeList>()
    }

}
impl SVGSVGElement {
    pub fn get_enclosure_list(&self, rect: DOMRectReadOnly, reference_element: SVGElement) -> NodeList {
        self.inner.call("getEnclosureList", &[rect.into(), reference_element.into(), ]).as_::<NodeList>()
    }

}
impl SVGSVGElement {
    pub fn check_intersection(&self, element: SVGElement, rect: DOMRectReadOnly) -> bool {
        self.inner.call("checkIntersection", &[element.into(), rect.into(), ]).as_::<bool>()
    }

}
impl SVGSVGElement {
    pub fn check_enclosure(&self, element: SVGElement, rect: DOMRectReadOnly) -> bool {
        self.inner.call("checkEnclosure", &[element.into(), rect.into(), ]).as_::<bool>()
    }
...
impl SVGSVGElement {
    pub fn create_svg_transform(&self, ) -> SVGTransform {
        self.inner.call("createSVGTransform", &[]).as_::<SVGTransform>()
    }
...
impl SVGSVGElement {
    pub fn suspend_redraw(&self, max_wait_milliseconds: u32) -> u32 {
        self.inner.call("suspendRedraw", &[max_wait_milliseconds.into(), ]).as_::<u32>()
    }

}
impl SVGSVGElement {
    pub fn unsuspend_redraw(&self, suspend_handle_id: u32) -> Undefined {
        self.inner.call("unsuspendRedraw", &[suspend_handle_id.into(), ]).as_::<Undefined>()
    }

}
impl SVGSVGElement {
    pub fn unsuspend_redraw_all(&self, ) -> Undefined {
        self.inner.call("unsuspendRedrawAll", &[]).as_::<Undefined>()
    }
...
impl SVGSVGElement {
    pub fn set_current_time(&self, seconds: f32) -> Undefined {
        self.inner.call("setCurrentTime", &[seconds.into(), ]).as_::<Undefined>()
    }
