...
impl std::ops::Deref for CSSTransformValue {
    type Target = CSSStyleValue;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for CSSTransformValue {
...
impl CSSTransformValue {
    pub fn new(transforms: jsbind::Sequence<CSSTransformComponent>) -> CSSTransformValue {
        Self {
