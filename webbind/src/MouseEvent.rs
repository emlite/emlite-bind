...
impl std::ops::Deref for MouseEvent {
    type Target = UIEvent;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for MouseEvent {
...
impl MouseEvent {
    pub fn new0(type_: jsbind::DOMString) -> MouseEvent {
        Self {
    ...
    pub fn new1(type_: jsbind::DOMString, event_init_dict: jsbind::Any) -> MouseEvent {
        Self {
            inner: emlite::Val::global("MouseEvent")
...
impl MouseEvent {
    pub fn init_mouse_event0(&self, type_arg: jsbind::DOMString) -> jsbind::Undefined {
        self.inner
            .call("initMouseEvent", &[type_arg.into()])
            .as_::<jsbind::Undefined>()
    }

    pub fn init_mouse_event1(
        &self,
