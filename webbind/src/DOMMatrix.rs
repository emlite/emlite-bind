...
impl DOMMatrix {
    ...
    pub fn new1(init: jsbind::Any) -> DOMMatrix {
        Self {
            inner: emlite::Val::global("DOMMatrix")
                .new(&[init.into()])
                .as_::<DOMMatrixReadOnly>(),
...
impl DOMMatrix {
    pub fn from_float32_array(array32: jsbind::Float32Array) -> DOMMatrix {
        emlite::Val::global("dommatrix")
...
impl DOMMatrix {
    pub fn from_float64_array(array64: jsbind::Float64Array) -> DOMMatrix {
        emlite::Val::global("dommatrix")
...
impl DOMMatrix {
    pub fn set_matrix_value(&self, transform_list: jsbind::DOMString) -> DOMMatrix {
        self.inner
