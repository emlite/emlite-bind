...
impl HTMLObjectElement {
    pub fn new() -> HTMLObjectElement {
        Self {
            inner: emlite::Val::global("HTMLObjectElement")
                .new(&[])
                .as_::<HTMLElement>(),
        }
    }
...
impl HTMLObjectElement {
    ...
    pub fn set_data(&mut self, value: jsbind::USVString) {
...
impl HTMLObjectElement {
    pub fn archive(&self) -> jsbind::DOMString {
        self.inner.get("archive").as_::<jsbind::DOMString>()
    }

    pub fn set_archive(&mut self, value: jsbind::DOMString) {
...
impl HTMLObjectElement {
    ...
    pub fn set_code(&mut self, value: jsbind::DOMString) {
...
impl HTMLObjectElement {
    pub fn standby(&self) -> jsbind::DOMString {
        self.inner.get("standby").as_::<jsbind::DOMString>()
    }

    pub fn set_standby(&mut self, value: jsbind::DOMString) {
...
impl HTMLObjectElement {
    pub fn code_base(&self) -> jsbind::DOMString {
        self.inner.get("codeBase").as_::<jsbind::DOMString>()
    }

    pub fn set_code_base(&mut self, value: jsbind::DOMString) {
        self.inner.set("codeBase", value);
    }
}
impl HTMLObjectElement {
    pub fn code_type(&self) -> jsbind::DOMString {
        self.inner.get("codeType").as_::<jsbind::DOMString>()
    }

    pub fn set_code_type(&mut self, value: jsbind::DOMString) {
