...
impl FromVal for AeadParams {
    fn from_val(v: &Any) -> Self {
        AeadParams { inner: v.clone() }
    }
...
impl core::ops::Deref for AeadParams {
    type Target = Any;
...
impl core::ops::DerefMut for AeadParams {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.inner
    }
}

impl AsRef<Any> for AeadParams {
    fn as_ref(&self) -> &Any {
        &self.inner
    }
}

impl AsMut<Any> for AeadParams {
    fn as_mut(&mut self) -> &mut Any {
        &mut self.inner
    }
}

impl From<AeadParams> for Any {
    fn from(s: AeadParams) -> Any {
