...
impl FromVal for Performance {
    fn from_val(v: &Any) -> Self {
        Performance { inner: EventTarget::from_val(v) }
    }
...
impl Performance {
    ...
    pub fn measure_user_agent_specific_memory(&self, ) -> Promise<MemoryMeasurement> {
        self.inner.call("measureUserAgentSpecificMemory", &[]).as_::<Promise<MemoryMeasurement>>()
    }
}
impl Performance {
...
impl Performance {
    ...
    pub fn clear_resource_timings(&self, ) -> Undefined {
        self.inner.call("clearResourceTimings", &[]).as_::<Undefined>()
    }
}
impl Performance {
    ...
    pub fn set_resource_timing_buffer_size(&self, max_size: u32) -> Undefined {
        self.inner.call("setResourceTimingBufferSize", &[max_size.into(), ]).as_::<Undefined>()
    }
}
impl Performance {
...
impl Performance {
    ...
    pub fn mark0(&self, mark_name: &JsString) -> PerformanceMark {
        self.inner.call("mark", &[mark_name.into(), ]).as_::<PerformanceMark>()
    }
    /// The mark method.
    /// [`Performance.mark`](https://developer.mozilla.org/en-US/docs/Web/API/Performance/mark)
    pub fn mark1(&self, mark_name: &JsString, mark_options: &PerformanceMarkOptions) -> PerformanceMark {
        self.inner.call("mark", &[mark_name.into(), mark_options.into(), ]).as_::<PerformanceMark>()
    }
}
impl Performance {
    ...
    pub fn clear_marks1(&self, mark_name: &JsString) -> Undefined {
        self.inner.call("clearMarks", &[mark_name.into(), ]).as_::<Undefined>()
    }
}
impl Performance {
    /// The measure method.
    ...
    pub fn measure0(&self, measure_name: &JsString) -> PerformanceMeasure {
        self.inner.call("measure", &[measure_name.into(), ]).as_::<PerformanceMeasure>()
    }
    /// The measure method.
    /// [`Performance.measure`](https://developer.mozilla.org/en-US/docs/Web/API/Performance/measure)
    pub fn measure1(&self, measure_name: &JsString, start_or_measure_options: &Any) -> PerformanceMeasure {
        self.inner.call("measure", &[measure_name.into(), start_or_measure_options.into(), ]).as_::<PerformanceMeasure>()
    }
    /// The measure method.
    /// [`Performance.measure`](https://developer.mozilla.org/en-US/docs/Web/API/Performance/measure)
    pub fn measure2(&self, measure_name: &JsString, start_or_measure_options: &Any, end_mark: &JsString) -> PerformanceMeasure {
        self.inner.call("measure", &[measure_name.into(), start_or_measure_options.into(), end_mark.into(), ]).as_::<PerformanceMeasure>()
    }
}
impl Performance {
    ...
    pub fn clear_measures1(&self, measure_name: &JsString) -> Undefined {
        self.inner.call("clearMeasures", &[measure_name.into(), ]).as_::<Undefined>()
    }
}
