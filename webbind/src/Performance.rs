...
impl Performance {
    pub fn measure_user_agent_specific_memory(&self, ) -> Promise {
        self.inner.call("measureUserAgentSpecificMemory", &[]).as_::<Promise>()
    }
...
impl Performance {
    ...
    pub fn mark1(&self, mark_name: DOMString, mark_options: PerformanceMarkOptions) -> PerformanceMark {
...
impl Performance {
    ...
    pub fn measure1(&self, measure_name: DOMString, start_or_measure_options: Any) -> PerformanceMeasure {
        self.inner.call("measure", &[measure_name.into(), start_or_measure_options.into(), ]).as_::<PerformanceMeasure>()
    }

    pub fn measure2(&self, measure_name: DOMString, start_or_measure_options: Any, end_mark: DOMString) -> PerformanceMeasure {
