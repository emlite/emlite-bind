...
impl HTMLInputElement {
    pub fn accept(&self) -> jsbind::DOMString {
        self.inner.get("accept").as_::<jsbind::DOMString>()
    }

    pub fn set_accept(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn color_space(&self) -> jsbind::DOMString {
        self.inner.get("colorSpace").as_::<jsbind::DOMString>()
    }

    pub fn set_color_space(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn max(&self) -> jsbind::DOMString {
        self.inner.get("max").as_::<jsbind::DOMString>()
    }

    pub fn set_max(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn min(&self) -> jsbind::DOMString {
        self.inner.get("min").as_::<jsbind::DOMString>()
    }

    pub fn set_min(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn pattern(&self) -> jsbind::DOMString {
        self.inner.get("pattern").as_::<jsbind::DOMString>()
    }

    pub fn set_pattern(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn step(&self) -> jsbind::DOMString {
        self.inner.get("step").as_::<jsbind::DOMString>()
    }

    pub fn set_step(&mut self, value: jsbind::DOMString) {
...
impl HTMLInputElement {
    pub fn value_as_date(&self) -> jsbind::Object {
        self.inner.get("valueAsDate").as_::<jsbind::Object>()
    }

    pub fn set_value_as_date(&mut self, value: jsbind::Object) {
...
impl HTMLInputElement {
    pub fn step_up0(&self) -> jsbind::Undefined {
        self.inner.call("stepUp", &[]).as_::<jsbind::Undefined>()
    }

    pub fn step_up1(&self, n: i32) -> jsbind::Undefined {
        self.inner
            .call("stepUp", &[n.into()])
...
impl HTMLInputElement {
    pub fn step_down0(&self) -> jsbind::Undefined {
        self.inner.call("stepDown", &[]).as_::<jsbind::Undefined>()
    }

    pub fn step_down1(&self, n: i32) -> jsbind::Undefined {
        self.inner
            .call("stepDown", &[n.into()])
            .as_::<jsbind::Undefined>()
    }
}
impl HTMLInputElement {
...
impl HTMLInputElement {
    pub fn webkit_entries(&self) -> jsbind::FrozenArray<FileSystemEntry> {
        self.inner
            .get("webkitEntries")
            .as_::<jsbind::FrozenArray<FileSystemEntry>>()
    }
}
impl HTMLInputElement {
    pub fn capture(&self) -> jsbind::DOMString {
        self.inner.get("capture").as_::<jsbind::DOMString>()
    }

    pub fn set_capture(&mut self, value: jsbind::DOMString) {
