...
impl HTMLInputElement {
    pub fn new() -> HTMLInputElement {
        Self {
            inner: emlite::Val::global("HTMLInputElement").new(&[]).as_::<HTMLElement>(),
        }
    }
...
impl HTMLInputElement {
    ...
    pub fn set_range_text1(&self, replacement: DOMString, start: u32, end: u32, selection_mode: SelectionMode) -> Undefined {
...
impl HTMLInputElement {
    pub fn webkit_entries(&self) -> FrozenArray<FileSystemEntry> {
        self.inner.get("webkitEntries").as_::<FrozenArray<FileSystemEntry>>()
    }
