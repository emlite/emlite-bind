...
impl USBDevice {
    pub fn manufacturer_name(&self) -> jsbind::DOMString {
        self.inner
...
impl USBDevice {
    pub fn configurations(&self) -> jsbind::FrozenArray<USBConfiguration> {
        self.inner
            .get("configurations")
            .as_::<jsbind::FrozenArray<USBConfiguration>>()
    }
}
impl USBDevice {
...
impl USBDevice {
    pub fn select_configuration(&self, configuration_value: u8) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn claim_interface(&self, interface_number: u8) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn release_interface(&self, interface_number: u8) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn control_transfer_out0(&self, setup: USBControlTransferParameters) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn clear_halt(&self, direction: USBDirection, endpoint_number: u8) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn transfer_in(&self, endpoint_number: u8, length: u32) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn transfer_out(&self, endpoint_number: u8, data: jsbind::Any) -> jsbind::Promise {
        self.inner
...
impl USBDevice {
    pub fn isochronous_transfer_in(
        &self,
        endpoint_number: u8,
        packet_lengths: jsbind::Sequence<u32>,
    ) -> jsbind::Promise {
        self.inner
            .call(
