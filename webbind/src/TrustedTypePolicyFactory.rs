...
impl FromVal for TrustedTypePolicyFactory {
    fn from_val(v: &Any) -> Self {
        TrustedTypePolicyFactory { inner: Any::from_val(v) }
    }
...
impl TrustedTypePolicyFactory {
    ...
    /// The createPolicy method.
    /// [`TrustedTypePolicyFactory.createPolicy`](https://developer.mozilla.org/en-US/docs/Web/API/TrustedTypePolicyFactory/createPolicy)
    pub fn create_policy1(&self, policy_name: &JsString, policy_options: &TrustedTypePolicyOptions) -> TrustedTypePolicy {
...
impl TrustedTypePolicyFactory {
    ...
    pub fn get_attribute_type0(&self, tag_name: &JsString, attribute: &JsString) -> JsString {
        self.inner.call("getAttributeType", &[tag_name.into(), attribute.into(), ]).as_::<JsString>()
    }
    /// The getAttributeType method.
    /// [`TrustedTypePolicyFactory.getAttributeType`](https://developer.mozilla.org/en-US/docs/Web/API/TrustedTypePolicyFactory/getAttributeType)
    pub fn get_attribute_type1(&self, tag_name: &JsString, attribute: &JsString, element_ns: &JsString) -> JsString {
        self.inner.call("getAttributeType", &[tag_name.into(), attribute.into(), element_ns.into(), ]).as_::<JsString>()
    }
    /// The getAttributeType method.
    /// [`TrustedTypePolicyFactory.getAttributeType`](https://developer.mozilla.org/en-US/docs/Web/API/TrustedTypePolicyFactory/getAttributeType)
    pub fn get_attribute_type2(&self, tag_name: &JsString, attribute: &JsString, element_ns: &JsString, attr_ns: &JsString) -> JsString {
        self.inner.call("getAttributeType", &[tag_name.into(), attribute.into(), element_ns.into(), attr_ns.into(), ]).as_::<JsString>()
    }
}
impl TrustedTypePolicyFactory {
    ...
    pub fn get_property_type0(&self, tag_name: &JsString, property: &JsString) -> JsString {
        self.inner.call("getPropertyType", &[tag_name.into(), property.into(), ]).as_::<JsString>()
    }
    /// The getPropertyType method.
    /// [`TrustedTypePolicyFactory.getPropertyType`](https://developer.mozilla.org/en-US/docs/Web/API/TrustedTypePolicyFactory/getPropertyType)
    pub fn get_property_type1(&self, tag_name: &JsString, property: &JsString, element_ns: &JsString) -> JsString {
        self.inner.call("getPropertyType", &[tag_name.into(), property.into(), element_ns.into(), ]).as_::<JsString>()
    }
}
impl TrustedTypePolicyFactory {
