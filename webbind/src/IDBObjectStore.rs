...
impl IDBObjectStore {
    pub fn put0(&self, value: jsbind::Any) -> IDBRequest {
        self.inner.call("put", &[value.into()]).as_::<IDBRequest>()
    }

    pub fn put1(&self, value: jsbind::Any, key: jsbind::Any) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    pub fn add0(&self, value: jsbind::Any) -> IDBRequest {
        self.inner.call("add", &[value.into()]).as_::<IDBRequest>()
    }

    pub fn add1(&self, value: jsbind::Any, key: jsbind::Any) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    pub fn delete(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    pub fn get(&self, query: jsbind::Any) -> IDBRequest {
        self.inner.call("get", &[query.into()]).as_::<IDBRequest>()
    }
}
impl IDBObjectStore {
    pub fn get_key(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    ...
    pub fn get_all1(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
            .call("getAll", &[query.into()])
            .as_::<IDBRequest>()
    }

    pub fn get_all2(&self, query: jsbind::Any, count: u32) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    ...
    pub fn get_all_keys1(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
            .call("getAllKeys", &[query.into()])
            .as_::<IDBRequest>()
    }

    pub fn get_all_keys2(&self, query: jsbind::Any, count: u32) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    ...
    pub fn count1(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    ...
    pub fn open_cursor1(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
            .call("openCursor", &[query.into()])
            .as_::<IDBRequest>()
    }

    pub fn open_cursor2(&self, query: jsbind::Any, direction: IDBCursorDirection) -> IDBRequest {
        self.inner
...
impl IDBObjectStore {
    ...
    pub fn open_key_cursor1(&self, query: jsbind::Any) -> IDBRequest {
        self.inner
            .call("openKeyCursor", &[query.into()])
            .as_::<IDBRequest>()
    }

    pub fn open_key_cursor2(
        &self,
        query: jsbind::Any,
...
impl IDBObjectStore {
    pub fn index(&self, name: jsbind::DOMString) -> IDBIndex {
        self.inner.call("index", &[name.into()]).as_::<IDBIndex>()
    }
}
impl IDBObjectStore {
    pub fn create_index0(&self, name: jsbind::DOMString, key_path: jsbind::Any) -> IDBIndex {
        self.inner
...
impl IDBObjectStore {
    pub fn delete_index(&self, name: jsbind::DOMString) -> jsbind::Undefined {
        self.inner
