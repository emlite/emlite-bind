...
impl MediaKeySession {
    ...
    pub fn closed(&self) -> Promise<MediaKeySessionClosedReason> {
        self.inner.get("closed").as_::<Promise<MediaKeySessionClosedReason>>()
    }
...
impl MediaKeySession {
    ...
    pub fn generate_request(&self, init_data_type: &JsString, init_data: &Any) -> Promise<Undefined> {
        self.inner.call("generateRequest", &[init_data_type.into(), init_data.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl MediaKeySession {
    /// The load method.
    ...
    pub fn load(&self, session_id: &JsString) -> Promise<bool> {
        self.inner.call("load", &[session_id.into(), ]).as_::<Promise<bool>>()
    }
}
impl MediaKeySession {
    /// The update method.
    ...
    pub fn update(&self, response: &Any) -> Promise<Undefined> {
        self.inner.call("update", &[response.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl MediaKeySession {
    /// The close method.
