...
impl PointerEvent {
    pub fn new0(type_: jsbind::DOMString) -> PointerEvent {
        Self {
    ...
    pub fn new1(type_: jsbind::DOMString, event_init_dict: jsbind::Any) -> PointerEvent {
        Self {
            inner: emlite::Val::global("PointerEvent")
...
impl PointerEvent {
    pub fn pointer_type(&self) -> jsbind::DOMString {
        self.inner.get("pointerType").as_::<jsbind::DOMString>()
    }
}
impl PointerEvent {
...
impl PointerEvent {
    pub fn get_coalesced_events(&self) -> jsbind::Sequence<PointerEvent> {
        self.inner
            .call("getCoalescedEvents", &[])
            .as_::<jsbind::Sequence<PointerEvent>>()
    }
}
impl PointerEvent {
    pub fn get_predicted_events(&self) -> jsbind::Sequence<PointerEvent> {
        self.inner
