...
impl GPUDevice {
    ...
    pub fn create_compute_pipeline_async(&self, descriptor: &GPUComputePipelineDescriptor) -> Promise<GPUComputePipeline> {
        self.inner.call("createComputePipelineAsync", &[descriptor.into(), ]).as_::<Promise<GPUComputePipeline>>()
    }
}
impl GPUDevice {
    ...
    pub fn create_render_pipeline_async(&self, descriptor: &GPURenderPipelineDescriptor) -> Promise<GPURenderPipeline> {
        self.inner.call("createRenderPipelineAsync", &[descriptor.into(), ]).as_::<Promise<GPURenderPipeline>>()
    }
}
impl GPUDevice {
...
impl GPUDevice {
    ...
    pub fn pop_error_scope(&self, ) -> Promise<GPUError> {
        self.inner.call("popErrorScope", &[]).as_::<Promise<GPUError>>()
    }
}
impl GPUDevice {
