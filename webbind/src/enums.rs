...
impl From<BackgroundFetchFailureReason> for emlite::Val {
    fn from(s: BackgroundFetchFailureReason) -> emlite::Val {
         match s {
            ...
            BackgroundFetchFailureReason::DOWNLOAD_TOTAL_EXCEEDED => emlite::Val::from("download-total-exceeded"),
         }
    }
}
...
impl From<ScriptingPolicyViolationType> for emlite::Val {
    fn from(s: ScriptingPolicyViolationType) -> emlite::Val {
         match s {
            ...
            ScriptingPolicyViolationType::INLINE_EVENT_HANDLER => emlite::Val::from("inlineEventHandler"),
...
impl From<MediaKeySessionClosedReason> for emlite::Val {
    fn from(s: MediaKeySessionClosedReason) -> emlite::Val {
         match s {
            ...
            MediaKeySessionClosedReason::CLOSED_BY_APPLICATION => emlite::Val::from("closed-by-application"),
            MediaKeySessionClosedReason::RELEASE_ACKNOWLEDGED => emlite::Val::from("release-acknowledged"),
            MediaKeySessionClosedReason::HARDWARE_CONTEXT_RESET => emlite::Val::from("hardware-context-reset"),
...
impl From<MediaKeyMessageType> for emlite::Val {
    fn from(s: MediaKeyMessageType) -> emlite::Val {
         match s {
            ...
            MediaKeyMessageType::INDIVIDUALIZATION_REQUEST => emlite::Val::from("individualization-request"),
         }
    }
}
...
impl From<FenceReportingDestination> for emlite::Val {
    fn from(s: FenceReportingDestination) -> emlite::Val {
         match s {
            ...
            FenceReportingDestination::SHARED_STORAGE_SELECT_URL => emlite::Val::from("shared-storage-select-url"),
         }
    }
}
...
impl From<DOMParserSupportedType> for emlite::Val {
    fn from(s: DOMParserSupportedType) -> emlite::Val {
         match s {
            ...
            DOMParserSupportedType::APPLICATION_XHTML_XML => emlite::Val::from("application/xhtml+xml"),
...
impl From<RTCDegradationPreference> for emlite::Val {
    fn from(s: RTCDegradationPreference) -> emlite::Val {
         match s {
            ...
            RTCDegradationPreference::MAINTAIN_RESOLUTION => emlite::Val::from("maintain-resolution"),
...
impl From<PrivateAttributionAggregationProtocol> for emlite::Val {
    fn from(s: PrivateAttributionAggregationProtocol) -> emlite::Val {
         match s {
            PrivateAttributionAggregationProtocol::DAP_12_HISTOGRAM => emlite::Val::from("dap-12-histogram"),
...
impl From<ReferrerPolicy> for emlite::Val {
    fn from(s: ReferrerPolicy) -> emlite::Val {
         match s {
            ...
            ReferrerPolicy::NO_REFERRER_WHEN_DOWNGRADE => emlite::Val::from("no-referrer-when-downgrade"),
            ...
            ReferrerPolicy::ORIGIN_WHEN_CROSS_ORIGIN => emlite::Val::from("origin-when-cross-origin"),
            ReferrerPolicy::STRICT_ORIGIN_WHEN_CROSS_ORIGIN => emlite::Val::from("strict-origin-when-cross-origin"),
...
impl From<ResizeObserverBoxOptions> for emlite::Val {
    fn from(s: ResizeObserverBoxOptions) -> emlite::Val {
         match s {
            ...
            ResizeObserverBoxOptions::DEVICE_PIXEL_CONTENT_BOX => emlite::Val::from("device-pixel-content-box"),
         }
    }
}
...
impl From<CaptureStartFocusBehavior> for emlite::Val {
    fn from(s: CaptureStartFocusBehavior) -> emlite::Val {
         match s {
            CaptureStartFocusBehavior::FOCUS_CAPTURING_APPLICATION => emlite::Val::from("focus-capturing-application"),
            CaptureStartFocusBehavior::FOCUS_CAPTURED_SURFACE => emlite::Val::from("focus-captured-surface"),
...
impl From<RouterSourceEnum> for emlite::Val {
    fn from(s: RouterSourceEnum) -> emlite::Val {
         match s {
            ...
            RouterSourceEnum::RACE_NETWORK_AND_FETCH_HANDLER => emlite::Val::from("race-network-and-fetch-handler"),
         }
    }
}
...
impl From<SpeechRecognitionErrorCode> for emlite::Val {
    fn from(s: SpeechRecognitionErrorCode) -> emlite::Val {
         match s {
            ...
            SpeechRecognitionErrorCode::SERVICE_NOT_ALLOWED => emlite::Val::from("service-not-allowed"),
            SpeechRecognitionErrorCode::LANGUAGE_NOT_SUPPORTED => emlite::Val::from("language-not-supported"),
            SpeechRecognitionErrorCode::PHRASES_NOT_SUPPORTED => emlite::Val::from("phrases-not-supported"),
         }
    }
}
...
impl From<SpeechSynthesisErrorCode> for emlite::Val {
    fn from(s: SpeechSynthesisErrorCode) -> emlite::Val {
         match s {
            ...
            SpeechSynthesisErrorCode::SYNTHESIS_UNAVAILABLE => emlite::Val::from("synthesis-unavailable"),
            SpeechSynthesisErrorCode::SYNTHESIS_FAILED => emlite::Val::from("synthesis-failed"),
            SpeechSynthesisErrorCode::LANGUAGE_UNAVAILABLE => emlite::Val::from("language-unavailable"),
...
impl From<ClientCapability> for emlite::Val {
    fn from(s: ClientCapability) -> emlite::Val {
         match s {
            ...
            ClientCapability::PASSKEY_PLATFORM_AUTHENTICATOR => emlite::Val::from("passkeyPlatformAuthenticator"),
            ClientCapability::USER_VERIFYING_PLATFORM_AUTHENTICATOR => emlite::Val::from("userVerifyingPlatformAuthenticator"),
            ClientCapability::RELATED_ORIGINS => emlite::Val::from("relatedOrigins"),
            ClientCapability::SIGNAL_ALL_ACCEPTED_CREDENTIALS => emlite::Val::from("signalAllAcceptedCredentials"),
            ClientCapability::SIGNAL_CURRENT_USER_DETAILS => emlite::Val::from("signalCurrentUserDetails"),
            ClientCapability::SIGNAL_UNKNOWN_CREDENTIAL => emlite::Val::from("signalUnknownCredential"),
         }
    }
}
...
impl From<GPUFeatureName> for emlite::Val {
    fn from(s: GPUFeatureName) -> emlite::Val {
         match s {
            GPUFeatureName::CORE_FEATURES_AND_LIMITS => emlite::Val::from("core-features-and-limits"),
            ...
            GPUFeatureName::TEXTURE_COMPRESSION_BC_SLICED_3D => emlite::Val::from("texture-compression-bc-sliced-3d"),
            GPUFeatureName::TEXTURE_COMPRESSION_ETC2 => emlite::Val::from("texture-compression-etc2"),
            GPUFeatureName::TEXTURE_COMPRESSION_ASTC => emlite::Val::from("texture-compression-astc"),
            GPUFeatureName::TEXTURE_COMPRESSION_ASTC_SLICED_3D => emlite::Val::from("texture-compression-astc-sliced-3d"),
            ...
            GPUFeatureName::RG11B10UFLOAT_RENDERABLE => emlite::Val::from("rg11b10ufloat-renderable"),
...
impl From<RTCErrorDetailTypeIdp> for emlite::Val {
    fn from(s: RTCErrorDetailTypeIdp) -> emlite::Val {
         match s {
            RTCErrorDetailTypeIdp::IDP_BAD_SCRIPT_FAILURE => emlite::Val::from("idp-bad-script-failure"),
            RTCErrorDetailTypeIdp::IDP_EXECUTION_FAILURE => emlite::Val::from("idp-execution-failure"),
...
impl From<RTCErrorDetailType> for emlite::Val {
    fn from(s: RTCErrorDetailType) -> emlite::Val {
         match s {
            ...
            RTCErrorDetailType::HARDWARE_ENCODER_NOT_AVAILABLE => emlite::Val::from("hardware-encoder-not-available"),
            RTCErrorDetailType::HARDWARE_ENCODER_ERROR => emlite::Val::from("hardware-encoder-error"),
         }
    }
}
...
impl From<WebTransportReliabilityMode> for emlite::Val {
    fn from(s: WebTransportReliabilityMode) -> emlite::Val {
         match s {
            ...
            WebTransportReliabilityMode::SUPPORTS_UNRELIABLE => emlite::Val::from("supports-unreliable"),
         }
    }
}
...
impl From<XRHandJoint> for emlite::Val {
    fn from(s: XRHandJoint) -> emlite::Val {
         match s {
            ...
            XRHandJoint::INDEX_FINGER_PHALANX_PROXIMAL => emlite::Val::from("index-finger-phalanx-proximal"),
            XRHandJoint::INDEX_FINGER_PHALANX_INTERMEDIATE => emlite::Val::from("index-finger-phalanx-intermediate"),
            XRHandJoint::INDEX_FINGER_PHALANX_DISTAL => emlite::Val::from("index-finger-phalanx-distal"),
            ...
            XRHandJoint::MIDDLE_FINGER_PHALANX_PROXIMAL => emlite::Val::from("middle-finger-phalanx-proximal"),
            XRHandJoint::MIDDLE_FINGER_PHALANX_INTERMEDIATE => emlite::Val::from("middle-finger-phalanx-intermediate"),
            XRHandJoint::MIDDLE_FINGER_PHALANX_DISTAL => emlite::Val::from("middle-finger-phalanx-distal"),
            ...
            XRHandJoint::RING_FINGER_PHALANX_PROXIMAL => emlite::Val::from("ring-finger-phalanx-proximal"),
            XRHandJoint::RING_FINGER_PHALANX_INTERMEDIATE => emlite::Val::from("ring-finger-phalanx-intermediate"),
            XRHandJoint::RING_FINGER_PHALANX_DISTAL => emlite::Val::from("ring-finger-phalanx-distal"),
            ...
            XRHandJoint::PINKY_FINGER_PHALANX_PROXIMAL => emlite::Val::from("pinky-finger-phalanx-proximal"),
            XRHandJoint::PINKY_FINGER_PHALANX_INTERMEDIATE => emlite::Val::from("pinky-finger-phalanx-intermediate"),
            XRHandJoint::PINKY_FINGER_PHALANX_DISTAL => emlite::Val::from("pinky-finger-phalanx-distal"),
