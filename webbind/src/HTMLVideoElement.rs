...
impl HTMLVideoElement {
    pub fn poster(&self) -> jsbind::USVString {
        self.inner.get("poster").as_::<jsbind::USVString>()
    }

    pub fn set_poster(&mut self, value: jsbind::USVString) {
...
impl HTMLVideoElement {
    pub fn request_picture_in_picture(&self) -> jsbind::Promise {
        self.inner
...
impl HTMLVideoElement {
    pub fn onenterpictureinpicture(&self) -> jsbind::Any {
        self.inner
            .get("onenterpictureinpicture")
            .as_::<jsbind::Any>()
    }

    pub fn set_onenterpictureinpicture(&mut self, value: jsbind::Any) {
        self.inner.set("onenterpictureinpicture", value);
    }
}
impl HTMLVideoElement {
    pub fn onleavepictureinpicture(&self) -> jsbind::Any {
        self.inner
            .get("onleavepictureinpicture")
            .as_::<jsbind::Any>()
    }

    pub fn set_onleavepictureinpicture(&mut self, value: jsbind::Any) {
...
impl HTMLVideoElement {
    pub fn request_video_frame_callback(&self, callback: jsbind::Function) -> u32 {
        self.inner
...
impl HTMLVideoElement {
    pub fn cancel_video_frame_callback(&self, handle: u32) -> jsbind::Undefined {
        self.inner
