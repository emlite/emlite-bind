...
impl std::ops::Deref for VTTCue {
    type Target = TextTrackCue;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for VTTCue {
...
impl VTTCue {
    pub fn new(start_time: f64, end_time: f64, text: jsbind::DOMString) -> VTTCue {
        Self {
...
impl VTTCue {
    pub fn line(&self) -> jsbind::Any {
        self.inner.get("line").as_::<jsbind::Any>()
    }

    pub fn set_line(&mut self, value: jsbind::Any) {
...
impl VTTCue {
    pub fn position(&self) -> jsbind::Any {
        self.inner.get("position").as_::<jsbind::Any>()
    }

    pub fn set_position(&mut self, value: jsbind::Any) {
