...
impl FromVal for HTMLTableElement {
    fn from_val(v: &emlite::Val) -> Self {
        HTMLTableElement { inner: HTMLElement::from_val(v) }
    }
...
impl HTMLTableElement {
    pub fn new() -> HTMLTableElement {
        Self {
            inner: emlite::Val::global("HTMLTableElement").new(&[]).as_::<HTMLElement>(),
        }
    }
...
impl HTMLTableElement {
    pub fn create_caption(&self, ) -> HTMLTableCaptionElement {
        self.inner.call("createCaption", &[]).as_::<HTMLTableCaptionElement>()
    }
...
impl HTMLTableElement {
    pub fn create_t_head(&self, ) -> HTMLTableSectionElement {
        self.inner.call("createTHead", &[]).as_::<HTMLTableSectionElement>()
    }
...
impl HTMLTableElement {
    pub fn create_t_foot(&self, ) -> HTMLTableSectionElement {
        self.inner.call("createTFoot", &[]).as_::<HTMLTableSectionElement>()
    }
...
impl HTMLTableElement {
    pub fn create_t_body(&self, ) -> HTMLTableSectionElement {
        self.inner.call("createTBody", &[]).as_::<HTMLTableSectionElement>()
    }
