...
impl FromVal for WebTransport {
    fn from_val(v: &Any) -> Self {
        WebTransport { inner: Any::from_val(v) }
    }
...
impl WebTransport {
    ...
    pub fn new1(url: &JsString, options: &WebTransportOptions) -> WebTransport {
        Self {
            inner: Any::global("WebTransport").new(&[url.into(), options.into()]).as_::<Any>(),
        }
    }
...
impl WebTransport {
    ...
    pub fn get_stats(&self, ) -> Promise<WebTransportConnectionStats> {
        self.inner.call("getStats", &[]).as_::<Promise<WebTransportConnectionStats>>()
    }
}
impl WebTransport {
    ...
    pub fn export_keying_material0(&self, label: &Any) -> Promise<ArrayBuffer> {
        self.inner.call("exportKeyingMaterial", &[label.into(), ]).as_::<Promise<ArrayBuffer>>()
    }
    /// The exportKeyingMaterial method.
    /// [`WebTransport.exportKeyingMaterial`](https://developer.mozilla.org/en-US/docs/Web/API/WebTransport/exportKeyingMaterial)
    pub fn export_keying_material1(&self, label: &Any, context: &Any) -> Promise<ArrayBuffer> {
        self.inner.call("exportKeyingMaterial", &[label.into(), context.into(), ]).as_::<Promise<ArrayBuffer>>()
    }
}
impl WebTransport {
...
impl WebTransport {
    ...
    pub fn closed(&self) -> Promise<WebTransportCloseInfo> {
        self.inner.get("closed").as_::<Promise<WebTransportCloseInfo>>()
    }
...
impl WebTransport {
    ...
    pub fn create_bidirectional_stream0(&self, ) -> Promise<WebTransportBidirectionalStream> {
        self.inner.call("createBidirectionalStream", &[]).as_::<Promise<WebTransportBidirectionalStream>>()
    }
    /// The createBidirectionalStream method.
    /// [`WebTransport.createBidirectionalStream`](https://developer.mozilla.org/en-US/docs/Web/API/WebTransport/createBidirectionalStream)
    pub fn create_bidirectional_stream1(&self, options: &WebTransportSendStreamOptions) -> Promise<WebTransportBidirectionalStream> {
        self.inner.call("createBidirectionalStream", &[options.into(), ]).as_::<Promise<WebTransportBidirectionalStream>>()
    }
}
impl WebTransport {
...
impl WebTransport {
    ...
    pub fn create_unidirectional_stream0(&self, ) -> Promise<WebTransportSendStream> {
        self.inner.call("createUnidirectionalStream", &[]).as_::<Promise<WebTransportSendStream>>()
    }
    /// The createUnidirectionalStream method.
    /// [`WebTransport.createUnidirectionalStream`](https://developer.mozilla.org/en-US/docs/Web/API/WebTransport/createUnidirectionalStream)
    pub fn create_unidirectional_stream1(&self, options: &WebTransportSendStreamOptions) -> Promise<WebTransportSendStream> {
        self.inner.call("createUnidirectionalStream", &[options.into(), ]).as_::<Promise<WebTransportSendStream>>()
    }
}
impl WebTransport {
...
impl WebTransport {
    ...
    pub fn supports_reliable_only() -> bool {
        Any::global("WebTransport").get("supportsReliableOnly").as_::<bool>()
    }
