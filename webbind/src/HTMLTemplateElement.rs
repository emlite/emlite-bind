...
impl HTMLTemplateElement {
    pub fn shadow_root_mode(&self) -> jsbind::DOMString {
        self.inner.get("shadowRootMode").as_::<jsbind::DOMString>()
    }

    pub fn set_shadow_root_mode(&mut self, value: jsbind::DOMString) {
...
impl HTMLTemplateElement {
    pub fn shadow_root_custom_element_registry(&self) -> jsbind::DOMString {
        self.inner
            .get("shadowRootCustomElementRegistry")
            .as_::<jsbind::DOMString>()
    }

    pub fn set_shadow_root_custom_element_registry(&mut self, value: jsbind::DOMString) {
