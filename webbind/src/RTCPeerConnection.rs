...
impl RTCConfiguration {
    pub fn certificates(&self) -> Sequence<RTCCertificate> {
        self.inner.get("certificates").as_::<Sequence<RTCCertificate>>()
    }
...
impl RTCPeerConnection {
    pub fn new0() -> RTCPeerConnection {
        Self {
            inner: emlite::Val::global("RTCPeerConnection").new(&[]).as_::<EventTarget>(),
        }
    }

    pub fn new1(configuration: RTCConfiguration) -> RTCPeerConnection {
        Self {
            inner: emlite::Val::global("RTCPeerConnection").new(&[configuration.into()]).as_::<EventTarget>(),
        }
    }
...
impl RTCPeerConnection {
    pub fn create_offer0(&self, success_callback: Function, failure_callback: Function) -> Promise {
        self.inner.call("createOffer", &[success_callback.into(), failure_callback.into(), ]).as_::<Promise>()
    }

    pub fn create_offer1(&self, success_callback: Function, failure_callback: Function, options: RTCOfferOptions) -> Promise {
        self.inner.call("createOffer", &[success_callback.into(), failure_callback.into(), options.into(), ]).as_::<Promise>()
    }

}
impl RTCPeerConnection {
    pub fn create_answer(&self, success_callback: Function, failure_callback: Function) -> Promise {
        self.inner.call("createAnswer", &[success_callback.into(), failure_callback.into(), ]).as_::<Promise>()
    }

}
impl RTCPeerConnection {
    pub fn set_local_description(&self, description: RTCLocalSessionDescriptionInit, success_callback: Any, failure_callback: Function) -> Promise {
        self.inner.call("setLocalDescription", &[description.into(), success_callback.into(), failure_callback.into(), ]).as_::<Promise>()
    }
...
impl RTCPeerConnection {
    pub fn set_remote_description(&self, description: RTCSessionDescriptionInit, success_callback: Any, failure_callback: Function) -> Promise {
        self.inner.call("setRemoteDescription", &[description.into(), success_callback.into(), failure_callback.into(), ]).as_::<Promise>()
    }
...
impl RTCPeerConnection {
    pub fn add_ice_candidate(&self, candidate: RTCIceCandidateInit, success_callback: Any, failure_callback: Function) -> Promise {
        self.inner.call("addIceCandidate", &[candidate.into(), success_callback.into(), failure_callback.into(), ]).as_::<Promise>()
    }
...
impl RTCPeerConnection {
    ...
    pub fn set_identity_provider1(&self, provider: DOMString, options: RTCIdentityProviderOptions) -> Undefined {
...
impl RTCPeerConnection {
    pub fn get_identity_assertion(&self, ) -> Promise {
        self.inner.call("getIdentityAssertion", &[]).as_::<Promise>()
    }
...
impl RTCPeerConnection {
    pub fn generate_certificate(keygen_algorithm: Any) -> Promise {
        emlite::Val::global("rtcpeerconnection").call("generateCertificate", &[keygen_algorithm.into(), ]).as_::<Promise>()
    }

}
impl RTCPeerConnection {
    pub fn get_senders(&self, ) -> Sequence<RTCRtpSender> {
        self.inner.call("getSenders", &[]).as_::<Sequence<RTCRtpSender>>()
    }

}
impl RTCPeerConnection {
    pub fn get_receivers(&self, ) -> Sequence<RTCRtpReceiver> {
        self.inner.call("getReceivers", &[]).as_::<Sequence<RTCRtpReceiver>>()
    }

}
impl RTCPeerConnection {
    pub fn get_transceivers(&self, ) -> Sequence<RTCRtpTransceiver> {
        self.inner.call("getTransceivers", &[]).as_::<Sequence<RTCRtpTransceiver>>()
    }
...
impl RTCPeerConnection {
    ...
    pub fn create_data_channel1(&self, label: USVString, data_channel_dict: RTCDataChannelInit) -> RTCDataChannel {
...
impl RTCPeerConnection {
    ...
    pub fn get_stats1(&self, selector: MediaStreamTrack) -> Promise {
        self.inner.call("getStats", &[selector.into(), ]).as_::<Promise>()
    }
