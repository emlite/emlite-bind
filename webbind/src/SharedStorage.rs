...
impl FromVal for SharedStorage {
    fn from_val(v: &Any) -> Self {
        SharedStorage { inner: Any::from_val(v) }
    }
...
impl SharedStorage {
    ...
    pub fn get(&self, key: &JsString) -> Promise<JsString> {
        self.inner.call("get", &[key.into(), ]).as_::<Promise<JsString>>()
    }
}
impl SharedStorage {
    /// The set method.
    ...
    pub fn set0(&self, key: &JsString, value: &JsString) -> Promise<Any> {
        self.inner.call("set", &[key.into(), value.into(), ]).as_::<Promise<Any>>()
    }
    /// The set method.
    /// [`SharedStorage.set`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/set)
    pub fn set1(&self, key: &JsString, value: &JsString, options: &SharedStorageSetMethodOptions) -> Promise<Any> {
        self.inner.call("set", &[key.into(), value.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    /// The append method.
    ...
    pub fn append0(&self, key: &JsString, value: &JsString) -> Promise<Any> {
        self.inner.call("append", &[key.into(), value.into(), ]).as_::<Promise<Any>>()
    }
    /// The append method.
    /// [`SharedStorage.append`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/append)
    pub fn append1(&self, key: &JsString, value: &JsString, options: &SharedStorageModifierMethodOptions) -> Promise<Any> {
        self.inner.call("append", &[key.into(), value.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    /// The delete method.
    ...
    pub fn delete0(&self, key: &JsString) -> Promise<Any> {
        self.inner.call("delete", &[key.into(), ]).as_::<Promise<Any>>()
    }
    /// The delete method.
    /// [`SharedStorage.delete`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/delete)
    pub fn delete1(&self, key: &JsString, options: &SharedStorageModifierMethodOptions) -> Promise<Any> {
        self.inner.call("delete", &[key.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    /// The clear method.
    ...
    pub fn clear1(&self, options: &SharedStorageModifierMethodOptions) -> Promise<Any> {
        self.inner.call("clear", &[options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    ...
    pub fn batch_update0(&self, methods: &TypedArray<SharedStorageModifierMethod>) -> Promise<Any> {
        self.inner.call("batchUpdate", &[methods.into(), ]).as_::<Promise<Any>>()
    }
    /// The batchUpdate method.
    /// [`SharedStorage.batchUpdate`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/batchUpdate)
    pub fn batch_update1(&self, methods: &TypedArray<SharedStorageModifierMethod>, options: &SharedStorageModifierMethodOptions) -> Promise<Any> {
        self.inner.call("batchUpdate", &[methods.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    /// The selectURL method.
    /// [`SharedStorage.selectURL`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/selectURL)
    pub fn select_url0(&self, name: &JsString, urls: &TypedArray<SharedStorageUrlWithMetadata>) -> Promise<Any> {
        self.inner.call("selectURL", &[name.into(), urls.into(), ]).as_::<Promise<Any>>()
    }
    /// The selectURL method.
    /// [`SharedStorage.selectURL`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/selectURL)
    pub fn select_url1(&self, name: &JsString, urls: &TypedArray<SharedStorageUrlWithMetadata>, options: &SharedStorageRunOperationMethodOptions) -> Promise<Any> {
        self.inner.call("selectURL", &[name.into(), urls.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    /// The run method.
    ...
    /// The run method.
    /// [`SharedStorage.run`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/run)
    pub fn run1(&self, name: &JsString, options: &SharedStorageRunOperationMethodOptions) -> Promise<Any> {
        self.inner.call("run", &[name.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl SharedStorage {
    ...
    pub fn create_worklet0(&self, module_url: &JsString) -> Promise<SharedStorageWorklet> {
        self.inner.call("createWorklet", &[module_url.into(), ]).as_::<Promise<SharedStorageWorklet>>()
    }
    /// The createWorklet method.
    /// [`SharedStorage.createWorklet`](https://developer.mozilla.org/en-US/docs/Web/API/SharedStorage/createWorklet)
    pub fn create_worklet1(&self, module_url: &JsString, options: &SharedStorageWorkletOptions) -> Promise<SharedStorageWorklet> {
        self.inner.call("createWorklet", &[module_url.into(), options.into(), ]).as_::<Promise<SharedStorageWorklet>>()
    }
}
impl SharedStorage {
...
impl SharedStorage {
    ...
    pub fn remaining_budget(&self, ) -> Promise<f64> {
        self.inner.call("remainingBudget", &[]).as_::<Promise<f64>>()
    }
}
