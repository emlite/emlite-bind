...
impl std::ops::Deref for PerformanceElementTiming {
    type Target = PerformanceEntry;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for PerformanceElementTiming {
...
impl PerformanceElementTiming {
    pub fn render_time(&self) -> jsbind::Any {
        self.inner.get("renderTime").as_::<jsbind::Any>()
    }
}
impl PerformanceElementTiming {
...
impl PerformanceElementTiming {
    pub fn identifier(&self) -> jsbind::DOMString {
        self.inner.get("identifier").as_::<jsbind::DOMString>()
    }
}
impl PerformanceElementTiming {
