...
impl StorageEvent {
    pub fn new0(type_: DOMString) -> StorageEvent {
        Self {
            inner: emlite::Val::global("StorageEvent").new(&[type_.into()]).as_::<Event>(),
        }
    }

    pub fn new1(type_: DOMString, event_init_dict: Any) -> StorageEvent {
        Self {
            inner: emlite::Val::global("StorageEvent").new(&[type_.into(), event_init_dict.into()]).as_::<Event>(),
        }
    }
...
impl StorageEvent {
    ...
    pub fn init_storage_event2(&self, type_: DOMString, bubbles: bool, cancelable: bool) -> Undefined {
        self.inner.call("initStorageEvent", &[type_.into(), bubbles.into(), cancelable.into(), ]).as_::<Undefined>()
    }

    pub fn init_storage_event3(&self, type_: DOMString, bubbles: bool, cancelable: bool, key: DOMString) -> Undefined {
        self.inner.call("initStorageEvent", &[type_.into(), bubbles.into(), cancelable.into(), key.into(), ]).as_::<Undefined>()
    }

    pub fn init_storage_event4(&self, type_: DOMString, bubbles: bool, cancelable: bool, key: DOMString, old_value: DOMString) -> Undefined {
        self.inner.call("initStorageEvent", &[type_.into(), bubbles.into(), cancelable.into(), key.into(), old_value.into(), ]).as_::<Undefined>()
    }

    pub fn init_storage_event5(&self, type_: DOMString, bubbles: bool, cancelable: bool, key: DOMString, old_value: DOMString, new_value: DOMString) -> Undefined {
    ...
    pub fn init_storage_event6(&self, type_: DOMString, bubbles: bool, cancelable: bool, key: DOMString, old_value: DOMString, new_value: DOMString, url: USVString) -> Undefined {
    ...
    pub fn init_storage_event7(&self, type_: DOMString, bubbles: bool, cancelable: bool, key: DOMString, old_value: DOMString, new_value: DOMString, url: USVString, storage_area: Storage) -> Undefined {
