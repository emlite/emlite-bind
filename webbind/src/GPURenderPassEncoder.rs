...
impl FromVal for GPURenderPassEncoder {
    fn from_val(v: &emlite::Val) -> Self {
        GPURenderPassEncoder { inner: emlite::Val::from_val(v) }
    }
...
impl GPURenderPassEncoder {
    pub fn set_viewport(&self, x: f32, y: f32, width: f32, height: f32, min_depth: f32, max_depth: f32) -> Undefined {
        self.inner.call("setViewport", &[x.into(), y.into(), width.into(), height.into(), min_depth.into(), max_depth.into(), ]).as_::<Undefined>()
    }

}
impl GPURenderPassEncoder {
    pub fn set_scissor_rect(&self, x: Any, y: Any, width: Any, height: Any) -> Undefined {
        self.inner.call("setScissorRect", &[x.into(), y.into(), width.into(), height.into(), ]).as_::<Undefined>()
    }

}
impl GPURenderPassEncoder {
    pub fn set_blend_constant(&self, color: Any) -> Undefined {
        self.inner.call("setBlendConstant", &[color.into(), ]).as_::<Undefined>()
    }

}
impl GPURenderPassEncoder {
    pub fn set_stencil_reference(&self, reference: Any) -> Undefined {
        self.inner.call("setStencilReference", &[reference.into(), ]).as_::<Undefined>()
    }

}
impl GPURenderPassEncoder {
    pub fn begin_occlusion_query(&self, query_index: Any) -> Undefined {
        self.inner.call("beginOcclusionQuery", &[query_index.into(), ]).as_::<Undefined>()
    }
...
impl GPURenderPassEncoder {
    pub fn execute_bundles(&self, bundles: Sequence<GPURenderBundle>) -> Undefined {
        self.inner.call("executeBundles", &[bundles.into(), ]).as_::<Undefined>()
    }
