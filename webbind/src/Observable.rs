...
impl FromVal for Observable {
    fn from_val(v: &Any) -> Self {
        Observable { inner: Any::from_val(v) }
    }
...
impl Observable {
    ...
    pub fn new(callback: &Function) -> Observable {
        Self {
            inner: Any::global("Observable").new(&[callback.into()]).as_::<Any>(),
        }
    }
...
impl Observable {
    ...
    pub fn from(value: &Any) -> Observable {
        Any::global("Observable").call("from", &[value.into(), ]).as_::<Observable>()
    }
}
impl Observable {
...
impl Observable {
    ...
    pub fn to_array0(&self, ) -> Promise<TypedArray<Any>> {
        self.inner.call("toArray", &[]).as_::<Promise<TypedArray<Any>>>()
    }
    /// The toArray method.
    /// [`Observable.toArray`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/toArray)
    pub fn to_array1(&self, options: &SubscribeOptions) -> Promise<TypedArray<Any>> {
        self.inner.call("toArray", &[options.into(), ]).as_::<Promise<TypedArray<Any>>>()
    }
}
impl Observable {
    /// The forEach method.
    ...
    pub fn for_each0(&self, callback: &Function) -> Promise<Undefined> {
        self.inner.call("forEach", &[callback.into(), ]).as_::<Promise<Undefined>>()
    }
    /// The forEach method.
    /// [`Observable.forEach`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/forEach)
    pub fn for_each1(&self, callback: &Function, options: &SubscribeOptions) -> Promise<Undefined> {
        self.inner.call("forEach", &[callback.into(), options.into(), ]).as_::<Promise<Undefined>>()
    }
}
impl Observable {
    /// The every method.
    ...
    pub fn every0(&self, predicate: &Function) -> Promise<bool> {
        self.inner.call("every", &[predicate.into(), ]).as_::<Promise<bool>>()
    }
    /// The every method.
    /// [`Observable.every`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/every)
    pub fn every1(&self, predicate: &Function, options: &SubscribeOptions) -> Promise<bool> {
        self.inner.call("every", &[predicate.into(), options.into(), ]).as_::<Promise<bool>>()
    }
}
impl Observable {
    /// The first method.
    ...
    pub fn first1(&self, options: &SubscribeOptions) -> Promise<Any> {
        self.inner.call("first", &[options.into(), ]).as_::<Promise<Any>>()
    }
}
impl Observable {
    /// The last method.
    ...
    pub fn last1(&self, options: &SubscribeOptions) -> Promise<Any> {
        self.inner.call("last", &[options.into(), ]).as_::<Promise<Any>>()
    }
}
impl Observable {
    /// The find method.
    ...
    pub fn find0(&self, predicate: &Function) -> Promise<Any> {
        self.inner.call("find", &[predicate.into(), ]).as_::<Promise<Any>>()
    }
    /// The find method.
    /// [`Observable.find`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/find)
    pub fn find1(&self, predicate: &Function, options: &SubscribeOptions) -> Promise<Any> {
        self.inner.call("find", &[predicate.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
impl Observable {
    /// The some method.
    ...
    pub fn some0(&self, predicate: &Function) -> Promise<bool> {
        self.inner.call("some", &[predicate.into(), ]).as_::<Promise<bool>>()
    }
    /// The some method.
    /// [`Observable.some`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/some)
    pub fn some1(&self, predicate: &Function, options: &SubscribeOptions) -> Promise<bool> {
        self.inner.call("some", &[predicate.into(), options.into(), ]).as_::<Promise<bool>>()
    }
}
impl Observable {
    /// The reduce method.
    ...
    pub fn reduce0(&self, reducer: &Function) -> Promise<Any> {
        self.inner.call("reduce", &[reducer.into(), ]).as_::<Promise<Any>>()
    }
    /// The reduce method.
    /// [`Observable.reduce`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/reduce)
    pub fn reduce1(&self, reducer: &Function, initial_value: &Any) -> Promise<Any> {
        self.inner.call("reduce", &[reducer.into(), initial_value.into(), ]).as_::<Promise<Any>>()
    }
    /// The reduce method.
    /// [`Observable.reduce`](https://developer.mozilla.org/en-US/docs/Web/API/Observable/reduce)
    pub fn reduce2(&self, reducer: &Function, initial_value: &Any, options: &SubscribeOptions) -> Promise<Any> {
        self.inner.call("reduce", &[reducer.into(), initial_value.into(), options.into(), ]).as_::<Promise<Any>>()
    }
}
