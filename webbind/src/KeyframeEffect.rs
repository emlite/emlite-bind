...
impl std::ops::Deref for KeyframeEffect {
    type Target = AnimationEffect;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for KeyframeEffect {
...
impl KeyframeEffect {
    pub fn get_keyframes(&self) -> jsbind::Sequence<jsbind::Object> {
        self.inner
            .call("getKeyframes", &[])
...
impl KeyframeEffect {
    pub fn set_keyframes(&self, keyframes: jsbind::Object) -> jsbind::Undefined {
        self.inner
