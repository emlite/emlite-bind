...
impl FromVal for WebGLRenderingContext {
    fn from_val(v: &Any) -> Self {
        WebGLRenderingContext { inner: Any::from_val(v) }
    }
...
impl WebGLRenderingContext {
    ...
    pub fn buffer_data(&self, target: &Any, data: &Any, usage: &Any) -> Undefined {
        self.inner.call("bufferData", &[target.into(), data.into(), usage.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn buffer_sub_data(&self, target: &Any, offset: &Any, data: &Any) -> Undefined {
        self.inner.call("bufferSubData", &[target.into(), offset.into(), data.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn compressed_tex_image2_d(&self, target: &Any, level: &Any, internalformat: &Any, width: &Any, height: &Any, border: &Any, data: &Any) -> Undefined {
        self.inner.call("compressedTexImage2D", &[target.into(), level.into(), internalformat.into(), width.into(), height.into(), border.into(), data.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn compressed_tex_sub_image2_d(&self, target: &Any, level: &Any, xoffset: &Any, yoffset: &Any, width: &Any, height: &Any, format: &Any, data: &Any) -> Undefined {
        self.inner.call("compressedTexSubImage2D", &[target.into(), level.into(), xoffset.into(), yoffset.into(), width.into(), height.into(), format.into(), data.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn read_pixels(&self, x: &Any, y: &Any, width: &Any, height: &Any, format: &Any, type_: &Any, pixels: &Any) -> Undefined {
        self.inner.call("readPixels", &[x.into(), y.into(), width.into(), height.into(), format.into(), type_.into(), pixels.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn tex_image2_d(&self, target: &Any, level: &Any, internalformat: &Any, format: &Any, type_: &Any, source: &Any) -> Undefined {
        self.inner.call("texImage2D", &[target.into(), level.into(), internalformat.into(), format.into(), type_.into(), source.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn tex_sub_image2_d(&self, target: &Any, level: &Any, xoffset: &Any, yoffset: &Any, format: &Any, type_: &Any, source: &Any) -> Undefined {
        self.inner.call("texSubImage2D", &[target.into(), level.into(), xoffset.into(), yoffset.into(), format.into(), type_.into(), source.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform1fv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform1fv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform2fv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform2fv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform3fv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform3fv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform4fv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform4fv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform1iv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform1iv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform2iv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform2iv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform3iv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform3iv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform4iv(&self, location: &WebGLUniformLocation, v: &Any) -> Undefined {
        self.inner.call("uniform4iv", &[location.into(), v.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform_matrix2fv(&self, location: &WebGLUniformLocation, transpose: &Any, value: &Any) -> Undefined {
        self.inner.call("uniformMatrix2fv", &[location.into(), transpose.into(), value.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform_matrix3fv(&self, location: &WebGLUniformLocation, transpose: &Any, value: &Any) -> Undefined {
        self.inner.call("uniformMatrix3fv", &[location.into(), transpose.into(), value.into(), ]).as_::<Undefined>()
    }
}
impl WebGLRenderingContext {
    ...
    pub fn uniform_matrix4fv(&self, location: &WebGLUniformLocation, transpose: &Any, value: &Any) -> Undefined {
        self.inner.call("uniformMatrix4fv", &[location.into(), transpose.into(), value.into(), ]).as_::<Undefined>()
    }
}
