...
impl PresentationRequest {
    ...
    pub fn new(urls: &TypedArray<JsString>) -> PresentationRequest {
        Self {
            inner: Any::global("PresentationRequest").new(&[urls.into()]).as_::<EventTarget>(),
        }
    }
...
impl PresentationRequest {
    ...
    pub fn start(&self, ) -> Promise<PresentationConnection> {
        self.inner.call("start", &[]).as_::<Promise<PresentationConnection>>()
    }
}
impl PresentationRequest {
    ...
    pub fn reconnect(&self, presentation_id: &JsString) -> Promise<PresentationConnection> {
        self.inner.call("reconnect", &[presentation_id.into(), ]).as_::<Promise<PresentationConnection>>()
    }
}
impl PresentationRequest {
    ...
    pub fn get_availability(&self, ) -> Promise<PresentationAvailability> {
        self.inner.call("getAvailability", &[]).as_::<Promise<PresentationAvailability>>()
    }
}
impl PresentationRequest {
