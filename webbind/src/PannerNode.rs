...
impl std::ops::Deref for PannerNode {
    type Target = AudioNode;
    fn deref(&self) -> &Self::Target {
        &self.inner
    }
}
impl std::ops::DerefMut for PannerNode {
...
impl PannerNode {
    ...
    pub fn new1(context: BaseAudioContext, options: jsbind::Any) -> PannerNode {
        Self {
            inner: emlite::Val::global("PannerNode")
...
impl PannerNode {
    pub fn set_orientation(&self, x: f32, y: f32, z: f32) -> jsbind::Undefined {
        self.inner
