...
impl FromVal for CSSStyleSheet {
    fn from_val(v: &emlite::Val) -> Self {
        CSSStyleSheet { inner: StyleSheet::from_val(v) }
    }
...
impl CSSStyleSheet {
    pub fn new0() -> CSSStyleSheet {
        Self {
            inner: emlite::Val::global("CSSStyleSheet").new(&[]).as_::<StyleSheet>(),
        }
    }

    pub fn new1(options: Any) -> CSSStyleSheet {
        Self {
            inner: emlite::Val::global("CSSStyleSheet").new(&[options.into()]).as_::<StyleSheet>(),
        }
    }
...
impl CSSStyleSheet {
    pub fn replace_sync(&self, text: USVString) -> Undefined {
        self.inner.call("replaceSync", &[text.into(), ]).as_::<Undefined>()
    }
...
impl CSSStyleSheet {
    ...
    pub fn add_rule2(&self, selector: DOMString, style: DOMString) -> i32 {
        self.inner.call("addRule", &[selector.into(), style.into(), ]).as_::<i32>()
    }

    pub fn add_rule3(&self, selector: DOMString, style: DOMString, index: u32) -> i32 {
        self.inner.call("addRule", &[selector.into(), style.into(), index.into(), ]).as_::<i32>()
    }
...
impl CSSStyleSheet {
    ...
    pub fn remove_rule1(&self, index: u32) -> Undefined {
        self.inner.call("removeRule", &[index.into(), ]).as_::<Undefined>()
    }
